...
export const WORKSPACE_REGISTRY: Record<string, WorkspaceRouteDefinition> = {
  ...
  DOMAIN_SUP_HOME: {
    ...
    tabId: 'overview',
    label: 'Suppliers & AP Workspace',
    labelUr: 'سپلائرز و اے پی ورک اسپیس',
  },
  SUP_OVERVIEW: {
    reportId: 'SUP_OVERVIEW',
    workspaceId: 'suppliers',
    tabId: 'overview',
    label: 'Accounts Payable Overview',
    labelUr: 'اکاؤنٹس پے ایبل خلاصہ',
  },
  SUP_REGISTER: {
    reportId: 'SUP_REGISTER',
    workspaceId: 'suppliers',
    tabId: 'register',
    label: 'Supplier Master Register',
  ...
  SUP_HISTORY: {
    ...
    workspaceId: 'suppliers',
    tabId: 'history',
    label: 'Bowser Purchase History',
    labelUr: 'باؤزر خریداری تاریخ',
  },
  SUP_PERFORMANCE: {
    reportId: 'SUP_PERFORMANCE',
    workspaceId: 'suppliers',
    tabId: 'performance',
    label: 'Supplier Performance Matrix',
    labelUr: 'سپلائر کارکردگی میٹرکس',
  },
  SUP_CONTRACTS: {
    reportId: 'SUP_CONTRACTS',
    workspaceId: 'suppliers',
    tabId: 'contracts',
    label: 'Contract & Pricing Registry',
    labelUr: 'معاہدے و ریٹ رجسٹر',
  },
  SUP_DOCUMENTS: {
    reportId: 'SUP_DOCUMENTS',
    workspaceId: 'suppliers',
    tabId: 'documents',
    label: 'Vendor Document Center',
    labelUr: 'وینڈر دستاویزات',
  },
  SUP_AUDIT: {
    reportId: 'SUP_AUDIT',
    workspaceId: 'suppliers',
    tabId: 'audit',
    label: 'Supplier Audit Trail',
    labelUr: 'سپلائر آڈٹ ٹریل',
  },
