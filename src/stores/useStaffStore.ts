...
interface StaffState {
  ...
  handleAddStaffFinance: (newEntry: StaffFinanceEntry, orgId?: string, stationId?: string, settings?: unknown, handleAddStandaloneExpenseStore?: (exp: ExpenseEntry) => void, handleUpdateBanksStore?: (banks: BankAccount[]) => void, banks?: BankAccount[]) => Promise<void>;
