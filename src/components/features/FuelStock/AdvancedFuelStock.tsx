...
export default function AdvancedFuelStock() {
 ...
 return (
 <div className="min-h-[85vh] bg-card text-foreground p-4 font-sans selection:bg-blue-500/30 rounded-2xl border border-border">
 ...
 <div className="bg-card backdrop-blur-md border border-border rounded-2xl overflow-hidden flex flex-col shadow-2xl">
 <div className="p-5 border-b border-border">
 <h2 className="text-lg font-bold text-white tracking-tight">Fuel Stock Import</h2>
 <p className="text-muted-foreground text-xs mt-0.5">Record new fuel delivery / import</p>
 </div>
 
 <form onSubmit={handleSaveImport} className="p-5 flex-1 flex flex-col gap-4">
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Supplier <span className="text-red-500">*</span></label>
 <select 
 name="supplierId"
 value={formData.supplierId}
 onChange={handleFormChange}
 className="w-full bg-card border border-border text-muted-foreground text-sm rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all"
 >
 ...
 <div>
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Fuel Type <span className="text-red-500">*</span></label>
 <select 
 name="fuelTypeId"
 ...
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Delivery Challan # <span className="text-red-500">*</span></label>
 <input 
 type="text" 
 name="challanNo"
 ...
 className="w-full bg-card border border-border text-muted-foreground text-sm rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all placeholder:text-slate-600"
 />
 </div>
 <div>
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Delivery Date <span className="text-red-500">*</span></label>
 <input 
 type="datetime-local" 
 name="date"
 value={formData.date}
 onChange={handleFormChange}
 className="w-full bg-card border border-border text-muted-foreground text-sm rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all [color-scheme:dark]"
 />
 </div>
 </div>
 ...
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Imported Quantity <span className="text-red-500">*</span></label>
 <input 
 type="number" 
 name="qty"
 value={formData.qty}
 onChange={handleFormChange}
 placeholder="0.00"
 className="w-full bg-card border border-border text-muted-foreground text-sm rounded-lg pl-3 pr-10 py-2.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all placeholder:text-slate-600"
 />
 <span className="absolute right-3 top-[30px] text-xs text-muted-foreground">Liter</span>
 </div>
 <div>
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Rate (Rs. / Ltr) <span className="text-red-500">*</span></label>
 <input 
 type="number" 
 name="rate"
 value={formData.rate}
 ...
 <div className="bg-card rounded-lg border border-border p-3 flex flex-col justify-center">
 <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Total Amount</span>
 ...
 <div>
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Payment Method</label>
 <select 
 name="paymentMethod"
 ...
 onChange={handleFormChange}
 className="w-full bg-card border border-blue-500/40 text-muted-foreground text-sm rounded-lg px-3 py-2.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all"
 >
 ...
 <div>
 <label className="block text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">Reference / Notes</label>
 <input 
 type="text" 
 name="notes"
 ...
 className="flex-1 flex items-center justify-center gap-2 bg-transparent border border-border text-muted-foreground py-2.5 rounded-lg text-sm font-semibold hover:bg-slate-800 transition-colors"
 >
 ...
 <div key={sup.id} className="flex items-center justify-between p-3 hover:bg-slate-800/50 rounded-xl transition-colors border-b border-border last:border-0">
 ...
 <div>
 <h4 className="text-foreground font-semibold text-sm truncate max-w-[150px]" title={sup.name}>{sup.name}</h4>
 <p className="text-muted-foreground text-[10px] mt-0.5">Outstanding Balance</p>
 </div>
 </div>
 <div className="text-right shrink-0">
 <p className="text-foreground font-bold text-sm">Rs. {sup.balance.toLocaleString()}</p>
 ...
 <button className="w-full flex items-center justify-center gap-2 bg-card border border-border hover:border-slate-700 text-muted-foreground py-2.5 rounded-lg text-sm font-semibold transition-colors">
 ...
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded bg-card border border-border flex items-center justify-center text-muted-foreground shadow-inner">
 <Fuel className="w-4 h-4" />
 </div>
 <div>
 <h4 className="text-foreground text-xs font-semibold">{tank.name} - {tank.productName}</h4>
 <p className="text-muted-foreground text-[10px]">Capacity: {tank.capacity.toLocaleString()} Ltr</p>
 </div>
 </div>
 <span className="text-emerald-400 font-bold text-sm" style={{color: tank.colorHex}}>{tank.pct}%</span>
 </div>
 <div className="h-2 w-full bg-card rounded-full overflow-hidden shadow-inner relative">
 <div 
 ...
 >
 <div className="absolute top-0 right-0 bottom-0 left-0 bg-card/20 w-full animate-[pulse_2s_infinite]"></div>
 </div>
 </div>
 </div>
 ))}
 ...
 <div className="p-4 border-t border-border mt-auto">
 <button className="w-full flex items-center justify-center gap-2 bg-card border border-border hover:border-slate-700 text-blue-400 py-2.5 rounded-lg text-sm font-semibold transition-colors">
 ...
 <div className="bg-card backdrop-blur-md border border-border rounded-2xl p-5 flex flex-col shadow-2xl">
 <div className="flex justify-between items-center mb-6">
 <h2 className="text-lg font-bold text-white tracking-tight">Fuel Stock Summary</h2>
 <select className="bg-card border border-border text-muted-foreground text-xs rounded px-2 py-1 outline-none">
 ...
 <span className="text-[9px] text-muted-foreground font-semibold uppercase tracking-wider">Total Stock</span>
 ...
 <span className="text-xs text-muted-foreground font-medium">{item.colorName}</span>
 </div>
 <div className="flex items-center gap-3">
 <span className="text-xs text-muted-foreground">{item.value.toLocaleString()} Ltr</span>
 ...
 {/* COL 2: STOCK TREND */}
 <div className="bg-card backdrop-blur-md border border-border rounded-2xl p-5 shadow-2xl flex flex-col">
 <div className="flex justify-between items-center mb-6">
 <h2 className="text-lg font-bold text-white tracking-tight">Stock Trend <span className="text-muted-foreground text-xs font-normal">(Liters)</span></h2>
 <select className="bg-card border border-border text-muted-foreground text-xs rounded px-2 py-1 outline-none">
 ...
 <div className="bg-card backdrop-blur-md border border-border rounded-2xl flex flex-col shadow-2xl h-[300px]">
 ...
 return (
 <div key={imp.id} className="flex items-center justify-between p-3 hover:bg-slate-800/50 rounded-xl transition-colors border-b border-border last:border-0">
 <div className="flex items-center gap-3">
 <div className="text-muted-foreground bg-card p-2 rounded border border-border">
 <Truck className="w-4 h-4" />
 </div>
 <div>
 <h4 className="text-foreground font-semibold text-sm truncate max-w-[120px]" title={sup?.name}>{sup?.name || 'any Supplier'}</h4>
 <p className="text-muted-foreground text-[10px] mt-0.5 truncate max-w-[120px]">{imp.by}</p>
 </div>
 </div>
 ...
 <p className="text-foreground font-bold text-sm">{imp.quantity.toLocaleString()} Ltr</p>
