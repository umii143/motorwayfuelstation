...
const MemoizedCustomerCard = React.memo(({
 ...
 : 'border-theme-main bg-theme-card hover:border-border dark:hover:border-white/10 hover:shadow-md'
 }`}
 >
 ...
 : 'bg-slate-50 text-slate-700 border-slate-100 /10 /20'
 }`}>
 {initials}
 </div>

 <div className="flex-1 min-w-0">
 <h4 className="font-sans text-sm font-bold text-foreground truncate">
 {t(cust.name, cust.urduName)}
 </h4>
 <span className="font-mono text-[10px] text-muted-foreground mt-0.5 block tracking-tight">
 📞 {cust.contact}
 </span>
 {cust.address && (
 <span className="font-sans text-[9px] text-muted-foreground truncate block mt-0.5">
 📍 {cust.address}
 </span>
 )}
 </div>
 ...
 : 'text-slate-500 bg-slate-50 dark:bg-card/5'
 }`}>
 ...
 className="flex items-center gap-1 rounded-md bg-card px-2 py-0.5 font-sans text-[9px] font-bold text-foreground hover:bg-slate-900 dark:hover:bg-card/20 transition-colors cursor-pointer min-h-0 min-w-0 mt-0.5"
 >
...
export default function CustomerDirectory({
 ...
 {/* TIME FILTER ROW */}
 <div className="flex bg-muted rounded-lg p-1 border border-theme-main shadow-sm overflow-x-auto no-scrollbar sm:w-max">
 ...
 <div className="rounded-xl border border-dashed border-theme-main py-12 text-center text-muted-foreground font-sans text-xs bg-theme-card">
 ...
 className="lg:hidden flex items-center gap-1.5 text-muted-foreground hover:text-slate-700 dark:hover:text-white mb-4 font-bold text-xs uppercase tracking-wider transition-colors min-h-0 min-w-0"
 >
 ...
 <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 font-sans text-xs text-muted-foreground font-medium">
 <span className="flex items-center gap-1"><Phone className="h-3 w-3 text-muted-foreground" /> {currentCustomer.contact}</span>
 <span className="flex items-center gap-1"><MapPin className="h-3 w-3 text-muted-foreground" /> {currentCustomer.address}</span>
 </div>
 </div>
 </div>
 ...
 className="flex items-center gap-1.5 rounded-lg border border-theme-main bg-theme-card px-3 py-1.5 font-sans text-xs font-bold text-muted-foreground hover:bg-slate-50 transition-colors cursor-pointer"
 >
 ...
 <div className="rounded-lg p-4 bg-theme-bg border border-border font-sans text-xs flex flex-col justify-between relative overflow-hidden">
 <div className="absolute top-0 bottom-0 left-0 w-1 bg-red-400"></div>
 <span className="text-muted-foreground font-bold uppercase tracking-wider">{t('Remaining Credit Space:', 'باقی گنجائش بقایا قرض:')}</span>
 <div className="mt-2.5 flex items-end justify-between">
 <div>
 <strong className="text-sm font-bold text-foreground">{formatCurrency(Math.max(0, currentCustomer.creditLimit - currentCustomer.balance), settings)}</strong>
 <span className="text-[10px] text-muted-foreground block mt-0.5">{t('Allocated Limit:', 'مقررہ حد کریڈٹ:')} {formatCurrency(currentCustomer.creditLimit, settings)}</span>
 </div>
 
 {/* Limit exhaustion gauge */}
 <span className="font-mono font-bold text-[10px] text-muted-foreground bg-slate-200/55 px-2 py-0.5 rounded-full">
 ...
 <div className="border border-theme-main border-dashed rounded-lg p-4 bg-subtle">
 {!isAddingTxn ? (
 <button
 onClick={() => setIsAddingTxn(true)}
 className="w-full py-2 bg-card text-foreground font-sans text-xs font-bold rounded-md hover:bg-slate-900 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
 >
 ...
 <strong className="font-sans text-xs font-bold text-foreground">{t('Direct Ledger Correction Entry:', 'کھاتیدار تصحیح فارم:')}</strong>
 <button type="button" onClick={() => setIsAddingTxn(false)} className="text-xs font-bold text-muted-foreground hover:text-slate-650">Cancel</button>
 </div>

 <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 min-h-[90px] gap-3.5 sm:grid-cols-2">
 <div>
 <label className="block text-[10px] font-bold text-muted-foreground uppercase mb-1">{t('Transaction nature:', 'انٹری کی قسم:')}</label>
 ...
 <div>
 <label className="block text-[10px] font-bold text-muted-foreground uppercase mb-1">{t('Amount (PKR Rupees):', 'رقم (روپے):')}</label>
 <input
 type="number"
 value={txnAmount}
 required
 ...
 <>
 <div>
 <label className="block text-[10px] font-bold text-muted-foreground uppercase mb-1">{t('Product:', 'پراڈکٹ:')}</label>
 ...
 <div>
 <label className="block text-[10px] font-bold text-muted-foreground uppercase mb-1">{t('Litres Volume (Optional):', 'مقدار لیٹر (اختیاری):')}</label>
 <input
 type="number"
 value={txnQty}
 ...
 <div>
 <label className="block text-[10px] font-bold text-muted-foreground uppercase mb-1">{t('Method:', 'طریقہ:')}</label>
 { }
 { }
 ...
 <label className="block text-[10px] font-bold text-muted-foreground uppercase mb-1">{t('Narration / Comment Note:', 'تفصیل / نوٹ:')}</label>
 <input
 type="text"
 value={txnNote}
 ...
 <h4 className="font-sans text-xs font-bold text-muted-foreground uppercase tracking-widest border-b border-border pb-2 mb-3">
 ...
 <div className="py-8 text-center text-muted-foreground font-medium bg-theme-card">
 ...
 <div className="h-full rounded-xl border border-dashed border-theme-main py-32 text-center text-muted-foreground font-sans text-sm flex flex-col justify-center items-center gap-4 bg-card/50">
 <div className="flex h-20 w-20 items-center justify-center rounded-full bg-muted text-muted-foreground ring-4 ring-white shadow-sm">
 ...
 <button onClick={() => setShowAddModal(false)} className="text-muted-foreground hover:text-slate-600 cursor-pointer text-xl">&times;</button>
 </div>

 <form onSubmit={handleAddNewCustomerSubmit} className="space-y-4">
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Customer / Company Name (English):', 'گاہک یا کمپنی کا نام (انگلش):')}</label>
 <input
 type="text"
 required
 value={addName}
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Urdu Name Representation (Bilingual):', 'گاہک یا کمپنی کا نام (اردو):')}</label>
 <input
 type="text"
 value={addUrduName}
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('WhatsApp Mobile No (WhatsApp Reminder):', 'واٹس ایپ موبائل نمبر (چالان کیلۓ):')}</label>
 <input
 type="text"
 value={addContact}
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Operational Depot Address:', 'کمپنی کا کامرس پتہ:')}</label>
 <input
 type="text"
 value={addAddress}
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t(`Credit Limit (${getCurrencySymbol(settings)}):`, 'قرض کی انتہائ حد:')}</label>
 <input
 type="number"
 value={addLimit}
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Opening Balance Dues:', 'ابتدائی بقایا رقم:')}</label>
 <input
 type="number"
 value={addOpeningBal}
 ...
 <button onClick={() => setShowEditModal(false)} className="text-muted-foreground hover:text-slate-700 text-xl font-bold cursor-pointer">&times;</button>
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Name (English):', 'نام (انگریزی):')}</label>
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Name (Urdu):', 'نام (اردو):')}</label>
 <input type="text" value={editCustUrduName} onChange={e => setEditCustUrduName(e.target.value)}
 className="premium-input border bg-theme-card px-3 font-sans text-sm focus:border-blue-500 outline-none" />
 </div>
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Contact:', 'رابطہ:')}</label>
 <input type="text" value={editCustContact} onChange={e => setEditCustContact(e.target.value)}
 className="premium-input border bg-theme-card px-3 font-sans text-sm focus:border-blue-500 outline-none" />
 </div>
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Address:', 'پتہ:')}</label>
 <input type="text" value={editCustAddress} onChange={e => setEditCustAddress(e.target.value)}
 className="premium-input border bg-theme-card px-3 font-sans text-sm focus:border-blue-500 outline-none" />
 </div>
 <div className="sm:col-span-2">
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Credit Limit (Rs):', 'ادھار حد (روپے):')}</label>
