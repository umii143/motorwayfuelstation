...
export default function AboutMe() {
 ...
 <div className="w-32 h-32 md:w-40 md:h-40 rounded-2xl border-4 border-border shadow-xl overflow-hidden bg-muted">
 <img 
 src="/umar_ali.png" 
 alt="Umar Ali" 
 ...
 <div className="absolute -bottom-2 -right-2 bg-green-500 w-6 h-6 rounded-full border-2 border-border flex items-center justify-center" title="Online & Active">
 <div className="w-2.5 h-2.5 bg-card rounded-full animate-pulse"></div>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="flex flex-col gap-2 text-sm text-muted-foreground bg-subtle p-4 rounded-xl border border-border">
 ...
 <p className="text-foreground font-medium">26 Years (Married)</p>
 </div>
 </li>
 <li className="flex items-start gap-3">
 <div className="mt-0.5 p-2 bg-card rounded-lg shadow-sm">
 ...
 <p className="text-foreground font-medium">BSc in Computer Science</p>
 </div>
 </li>
 <li className="flex items-start gap-3">
 <div className="mt-0.5 p-2 bg-card rounded-lg shadow-sm">
 ...
 <div>
 <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Profession</p>
 <p className="text-foreground font-medium leading-tight">Businessman, Software Developer & Digital Content Creator</p>
 </div>
 </li>
 </ul>
 </div>
