...
export const AIAssistantWidget: React.FC = () => {
 ...
 : msg.isReceiptFormat
 ? 'bg-card border border-border text-foreground rounded-bl-none shadow-sm font-mono text-[10px] sm:text-xs leading-relaxed whitespace-pre'
 ...
 <div className="premium-card border border-border text-muted-foreground rounded-bl-none px-4 py-3 flex items-center ga text-sm font-medium">
