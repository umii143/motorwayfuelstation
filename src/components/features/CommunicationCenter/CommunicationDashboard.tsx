...
export const CommunicationDashboard: React.FC = () => {
 ...
 <p className="text-muted-foreground text-sm mt-1">Manage outbound notifications, EOD summaries, and credit reminders.</p>
 </div>
 </div>
 ...
 {/* EOD Summary Card */}
 <div className="premium-card border border-border hover:shadow-md transition-shadow">
 <div className="w-12 h-12 bg-indigo-50 rounded-xl flex items-center justify-center mb-4">
 <Send className="w-6 h-6 text-indigo-600" />
 </div>
 <h2 className="text-lg font-semibold text-foreground mb-2">Executive EOD Summary</h2>
 ...
 disabled={isSending}
 className="w-full flex items-center justify-center gap-2 py-3 bg-card hover:bg-slate-900 text-foreground rounded-xl font-medium transition-colors disabled:opacity-50"
 >
 ...
 <h2 className="text-lg font-semibold text-foreground mb-2">Bulk Credit Reminders</h2>
 <p className="text-sm text-muted-foreground mb-6">
 Send customized WhatsApp payment reminders to all active credit accounts with pending balances.
 </p>
 <div className="flex items-center justify-between mb-4 px-4 py-2 bg-subtle rounded-lg border border-border">
 <span className="text-sm text-muted-foreground font-medium">Pending Customers:</span>
 <span className="text-lg font-bold text-foreground">{pendingCustomers.length}</span>
 </div>
 <button 
