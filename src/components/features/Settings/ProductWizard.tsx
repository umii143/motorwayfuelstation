...
export default function ProductWizard({ isLube, products, language, onUpdateProducts, onLogAudit }: ProductWizardProps) {
 ...
 <div className="text-center border-b border-border p-6 bg-subtle">
 ...
 className={`h-16 border-2 rounded-2xl flex items-center justify-between px-4 transition-all duration-200 cursor-pointer${isPresetAdded(preset.name) 
 ? 'border-emerald-500 bg-emerald-50 opacity-60 cursor-not-allowed' 
 : 'border-border hover:border-orange-500 hover:shadow-md bg-card'
 }`}
 >
 ...
 <input
 className="flex-1 h-14 px-4 bg-subtle border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:bg-card transition-colors font-medium text-foreground"
 ...
 className="size-14 bg-card text-foreground rounded-xl flex items-center justify-center hover:bg-slate-900 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shrink-0 shadow-md"
 >
