...
export default function LicenseSubscription({ settings }: { settings: GlobalSettings }) {
 ...
 <input
 type="text"
 className="block w-full pl-10 pr-3 py-2 border border-border rounded-lg leading-5 bg-card placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all shadow-sm"
 ...
 {/* Client Overview */}
 <div className="bg-card rounded-2xl border border-border p-6 shadow-sm flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
 <div className="flex items-center gap-4">
 <div className="h-16 w-16 bg-gradient-to-br from-indigo-100 to-slate-100 rounded-full flex items-center justify-center text-indigo-700 font-bold text-2xl border-4 border-border shadow-sm shrink-0">
 AK
 </div>
 <div>
 ...
 <Building className="h-4 w-4 text-muted-foreground" /> Khan Petroleum LLC
 </p>
 </div>
 </div>
 ...
 <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">{t('Client Since', 'کلائنٹ کب سے ہیں')}</span>
 <span className="text-foreground font-bold flex items-center gap-1.5"><Calendar className="h-4 w-4 text-indigo-500" /> Mar 2022</span>
 ...
 <div className="flex flex-col gap-1.5 min-w-[120px]">
 <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">{t('Total Purchases', 'کل خریداریاں')}</span>
 <span className="text-foreground font-bold flex items-center gap-1.5"><History className="h-4 w-4 text-emerald-500" /> {totalPurchases} Licenses</span>
 <span className="text-xs text-emerald-600 font-bold bg-emerald-50 inline-flex px-2 py-0.5 rounded w-fit">LTV: $4,500</span>
 </div>
 <div className="w-px bg-slate-200 hidden sm:block"></div>
 <div className="flex flex-col gap-1.5 min-w-[120px]">
 <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">{t('Account Status', 'اکاؤنٹ کی حیثیت')}</span>
 ...
 <div className={`lg:col-span-2 premium-card border border-border rounded-2xl overflow-hidden shadow-sm bg-card relative transition-all duration-300${!isPlanActive ? 'opacity-80 grayscale-[0.4] bg-slate-50 dark:bg-card/5' : ''}`}>
 ...
 <div className={`hidden sm:flex h-16 w-16 rounded-2xl items-center justify-center border shadow-inner${isPlanActive ? 'bg-indigo-50 border-indigo-100' : 'bg-muted border-border'}`}>
 ...
 <div className="text-foreground font-bold text-lg">15 Jun 2025</div>
 </div>
 <div className="bg-subtle rounded-xl p-4 border border-border">
 <div className="flex items-center gap-2 text-muted-foreground text-sm font-semibold mb-1">
 ...
 <div className="text-foreground font-bold text-lg">15 Jun 2026</div>
 </div>
 ...
 <span className="text-muted-foreground">{t('Subscription Progress', 'سبسکرپشن کی پیشرفت')}</span>
 ...
 <div className="bg-subtle border-t border-border px-6 sm:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
 <div className="text-sm flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 w-full">
 <div className="flex items-center gap-2 text-muted-foreground">
 <span className="text-muted-foreground">{t('License Key:', 'لائسنس کی:')}</span>
 <span className="font-mono font-bold text-foreground bg-card px-2 py-0.5 rounded border border-border">FP-ENT-8842-XXXX</span>
 </div>
 <div className="hidden sm:block w-1 h-1 rounded-full bg-slate-300"></div>
 <div className="flex items-center gap-2 text-muted-foreground">
 <span className="text-muted-foreground">{t('Stations:', 'اسٹیشنز:')}</span>
 ...
 <h3 className="text-base font-bold text-foreground mb-4">{t('Billing & Management', 'بلنگ اور مینجمنٹ')}</h3>
 ...
 <button className="w-full flex items-center justify-between px-4 py-3 bg-card border border-border hover:border-indigo-300 text-foreground rounded-xl text-sm font-semibold shadow-sm hover:bg-indigo-50 transition-all group">
 <div className="flex items-center gap-3">
 <CreditCard className="h-5 w-5 text-muted-foreground group-hover:text-indigo-600 transition-colors" />
 {t('Payment Methods', 'ادائیگی کے طریقے')}
 </div>
 <ExternalLink className="h-4 w-4 text-muted-foreground group-hover:text-indigo-500" />
 </button>
 
 <button 
 onClick={() => setIsPlanActive(!isPlanActive)}
 className={`w-full flex items-center justify-between px-4 py-3 bg-card border rounded-xl text-sm font-semibold shadow-sm transition-all group${isPlanActive ? 'border-border hover:border-rose-300 hover:bg-rose-50 text-slate-700' : 'border-emerald-300 bg-emerald-50 text-emerald-800 hover:bg-emerald-100'}`}
 >
 <div className="flex items-center gap-3">
 ...
 {/* Features Included */}
 <div className="bg-card rounded-2xl p-6 text-foreground shadow-lg relative overflow-hidden">
 <div className="absolute -right-4 -top-4 w-24 h-24 bg-card opacity-5 rounded-full blur-2xl"></div>
 <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-4">{t('Included in Enterprise', 'انٹرپرائز میں شامل')}</h3>
 ...
 <div className="p-6 border-b border-border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-subtle">
 <div>
 <h3 className="text-lg font-bold text-foreground">{t('Purchase & Activation History', 'خریداری اور ایکٹیویشن کی تاریخ')}</h3>
 <p className="text-sm text-muted-foreground mt-1">{t('Detailed log of all your software purchases and active licenses.', 'آپ کی تمام سافٹ ویئر کی خریداریوں اور فعال لائسنسز کا تفصیلی لاگ۔')}</p>
 </div>
 ...
 <thead className="bg-subtle text-muted-foreground uppercase text-xs font-bold border-b border-border">
 <tr>
 ...
 <td className="px-6 py-4 whitespace-nowrap font-medium text-foreground">15 Jun 2025</td>
 <td className="px-6 py-4 font-bold text-indigo-600">FuelPro Enterprise V3.0</td>
 <td className="px-6 py-4 font-medium text-foreground">Renewal</td>
 ...
 <tr className="hover:bg-slate-50 transition-colors">
 <td className="px-6 py-4 whitespace-nowrap font-medium text-foreground">15 Jun 2024</td>
 ...
 <tr className="hover:bg-slate-50 transition-colors">
 <td className="px-6 py-4 whitespace-nowrap font-medium text-foreground">10 Mar 2022</td>
