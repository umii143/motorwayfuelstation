    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 dark:border-white/10 pb-4">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            type="text"
            className="block w-full pl-10 pr-3 py-2 border border-slate-300 rounded-lg leading-5 bg-white dark:bg-[#151521] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all shadow-sm"
      ...
      {/* Client Overview */}
      <div className="bg-white dark:bg-[#151521] rounded-2xl border border-slate-200 dark:border-white/10 p-6 shadow-sm flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
        ...
        <div className="flex gap-6 sm:gap-8 w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0">
           <div className="flex flex-col gap-1.5 min-w-[120px]">
              ...
              <span className="text-slate-800 dark:text-slate-200 font-bold flex items-center gap-1.5"><Calendar className="h-4 w-4 text-indigo-500" /> Mar 2022</span>
           ...
           <div className="flex flex-col gap-1.5 min-w-[120px]">
              ...
              <span className="text-slate-800 dark:text-slate-200 font-bold flex items-center gap-1.5"><History className="h-4 w-4 text-emerald-500" /> {totalPurchases} Licenses</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className={`lg:col-span-2 premium-card border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm bg-white dark:bg-[#151521] relative transition-all duration-300 ${!isPlanActive ? 'opacity-80 grayscale-[0.4] bg-slate-50 dark:bg-white/5' : ''}`}>
          ...
          <div className="p-6 sm:p-8">
            <div className="flex justify-between items-start mb-8">
              ...
              <div className={`hidden sm:flex h-16 w-16 rounded-2xl items-center justify-center border shadow-inner ${isPlanActive ? 'bg-indigo-50 border-indigo-100' : 'bg-slate-100 dark:bg-white/10 border-slate-200 dark:border-white/10'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div className="bg-slate-50 dark:bg-white/5 rounded-xl p-4 border border-slate-100 dark:border-white/5">
                ...
                <div className="text-slate-900 dark:text-white font-bold text-lg">15 Jun 2025</div>
              </div>
              <div className="bg-slate-50 dark:bg-white/5 rounded-xl p-4 border border-slate-100 dark:border-white/5">
                <div className="flex items-center gap-2 text-slate-500 text-sm font-semibold mb-1">
                ...
                <div className="text-slate-900 dark:text-white font-bold text-lg">15 Jun 2026</div>
              </div>
          ...
          <div className="bg-slate-50 dark:bg-white/5 border-t border-slate-100 dark:border-white/5 px-6 sm:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="text-sm flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 w-full">
               <div className="flex items-center gap-2 text-slate-600">
                 ...
                 <span className="font-mono font-bold text-slate-800 dark:text-slate-200 bg-white dark:bg-[#151521] px-2 py-0.5 rounded border border-slate-200 dark:border-white/10">FP-ENT-8842-XXXX</span>
               </div>
               <div className="hidden sm:block w-1 h-1 rounded-full bg-slate-300"></div>
               <div className="flex items-center gap-2 text-slate-600">
                 <span className="text-slate-400">{t('Stations:', 'اسٹیشنز:')}</span>
                 <span className="font-bold text-slate-800 dark:text-slate-200">Unlimited</span>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-white dark:bg-[#151521] rounded-2xl border border-slate-200 dark:border-white/10 p-6 shadow-sm">
            <h3 className="text-base font-bold text-slate-900 dark:text-white mb-4">{t('Billing & Management', 'بلنگ اور مینجمنٹ')}</h3>
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-between px-4 py-3 bg-white dark:bg-[#151521] border border-slate-200 dark:border-white/10 hover:border-indigo-300 text-slate-700 rounded-xl text-sm font-semibold shadow-sm hover:bg-indigo-50 transition-all group">
              ...
              <button 
                ...
                className={`w-full flex items-center justify-between px-4 py-3 bg-white dark:bg-[#151521] border rounded-xl text-sm font-semibold shadow-sm transition-all group ${isPlanActive ? 'border-slate-200 dark:border-white/10 hover:border-rose-300 hover:bg-rose-50 text-slate-700' : 'border-emerald-300 bg-emerald-50 text-emerald-800 hover:bg-emerald-100'}`}
              >
                <div className="flex items-center gap-3">
          ...
          <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
             <div className="absolute -right-4 -top-4 w-24 h-24 bg-white dark:bg-[#151521] opacity-5 rounded-full blur-2xl"></div>
      ...
      <div className="bg-white dark:bg-[#151521] rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden shadow-sm mt-6">
        <div className="p-6 border-b border-slate-100 dark:border-white/5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50 dark:bg-white/5">
          <div>
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">{t('Purchase & Activation History', 'خریداری اور ایکٹیویشن کی تاریخ')}</h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-slate-600">
            <thead className="bg-slate-50 dark:bg-white/5 text-slate-500 uppercase text-xs font-bold border-b border-slate-200 dark:border-white/10">
              <tr>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50 dark:bg-white/5 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap font-medium text-slate-900 dark:text-white">15 Jun 2025</td>
              ...
              <tr className="hover:bg-slate-50 dark:bg-white/5 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap font-medium text-slate-900 dark:text-white">15 Jun 2024</td>
              ...
              <tr className="hover:bg-slate-50 dark:bg-white/5 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap font-medium text-slate-900 dark:text-white">10 Mar 2022</td>
