  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-slate-200 dark:border-white/10 pb-4">
        <h2 className="text-xl font-bold text-slate-900 dark:text-white">{t('Backup & Recovery', 'بیک اپ اور ریکوری')}</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* EXPORT SECTION */}
        <div className="bg-white dark:bg-[#151521] rounded-xl border border-slate-200 dark:border-white/10 shadow-xs overflow-hidden flex flex-col">
          <div className="px-6 py-4 border-b border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 flex items-center gap-3">
            <div className="h-8 w-8 rounded-full bg-orange-100 flex items-center justify-center text-orange-600">
              <DownloadCloud className="h-4 w-4" />
            </div>
            <h3 className="text-base font-bold text-slate-800 dark:text-slate-200">{t('Export Backup', 'بیک اپ ایکسپورٹ کریں')}</h3>
          </div>
          ...
          <div className="p-6 flex-1 flex flex-col space-y-4">
            ...
            <button 
              ...
              className="w-full flex items-center gap-4 p-4 rounded-xl border border-slate-200 dark:border-white/10 hover:border-orange-300 hover:bg-orange-50 transition-all text-left disabled:opacity-50"
            >
              <div className="h-10 w-10 rounded-lg bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0">
                <Clock className="h-5 w-5" />
              </div>
              <div>
                <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200">{t('Quick Backup', 'فوری بیک اپ')}</h4>
            ...
            >
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200">{t('Daily Backup', 'یومیہ بیک اپ')}</h4>
            ...
            <button 
              ...
              disabled={isExporting}
              className="w-full flex items-center gap-4 p-4 rounded-xl border border-slate-200 dark:border-white/10 hover:border-orange-300 hover:bg-orange-50 transition-all text-left disabled:opacity-50 relative overflow-hidden"
            >
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200">{t('Full Backup', 'مکمل بیک اپ')}</h4>
        ...
        <div className="bg-white dark:bg-[#151521] rounded-xl border border-slate-200 dark:border-white/10 shadow-xs overflow-hidden flex flex-col">
          <div className="px-6 py-4 border-b border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 flex items-center gap-3">
            ...
            <h3 className="text-base font-bold text-slate-800 dark:text-slate-200">{t('Restore Backup', 'بیک اپ بحال کریں')}</h3>
          </div>
          
          <div className="p-6 flex-1 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-white/10 m-6 rounded-xl bg-slate-50 dark:bg-white/5 relative">
            <input 
              type="file" 
              accept=".fuelpro"
              ref={fileInputRef}
            ...
            {restoreFile ? (
              <div className="text-center w-full px-4">
                ...
                <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 truncate px-4">{restoreFile.name}</h4>
                ...
                <div className="mt-6 flex flex-col gap-2 w-full max-w-xs mx-auto">
                  ...
                  <button 
                    ...
                    disabled={isRestoring}
                    className="w-full px-4 py-2 bg-white dark:bg-[#151521] text-slate-600 border border-slate-200 dark:border-white/10 rounded-lg text-sm font-bold shadow-xs hover:bg-slate-50 dark:bg-white/5 transition-colors disabled:opacity-70"
                  >
                    {t('Cancel', 'کینسل')}
                  </button>
                </div>
              ...
              <div className="text-center">
                <div className="mx-auto w-16 h-16 bg-slate-100 dark:bg-white/10 rounded-full flex items-center justify-center text-slate-400 mb-4">
                ...
                <button 
                  ...
                  className="mt-6 px-6 py-2.5 bg-white dark:bg-[#151521] border border-slate-300 text-slate-700 rounded-lg text-sm font-bold shadow-xs hover:bg-slate-50 dark:bg-white/5 transition-all hover:border-slate-400"
                >
