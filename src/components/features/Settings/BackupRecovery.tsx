...
export default function BackupRecovery({ settings, activeStationId }: { settings: GlobalSettings, activeStationId: string }) {
 ...
 <h2 className="text-xl font-bold text-foreground">{t('Backup & Recovery', 'بیک اپ اور ریکوری')}</h2>
 ...
 <div className="px-6 py-4 border-b border-border bg-subtle flex items-center gap-3">
 <div className="h-8 w-8 rounded-full bg-orange-100 flex items-center justify-center text-orange-600">
 <DownloadCloud className="h-4 w-4" />
 </div>
 <h3 className="text-base font-bold text-foreground">{t('Export Backup', 'بیک اپ ایکسپورٹ کریں')}</h3>
 </div>
 ...
 className="w-full flex items-center gap-4 p-4 rounded-xl border border-border hover:border-orange-300 hover:bg-orange-50 transition-all text-left disabled:opacity-50"
 >
 <div className="h-10 w-10 rounded-lg bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0">
 <Clock className="h-5 w-5" />
 </div>
 <div>
 <h4 className="text-sm font-bold text-foreground">{t('Quick Backup', 'فوری بیک اپ')}</h4>
 <p className="text-xs text-muted-foreground mt-0.5">Settings, Users, Treasury</p>
 </div>
 </button>
 ...
 <div>
 <h4 className="text-sm font-bold text-foreground">{t('Daily Backup', 'یومیہ بیک اپ')}</h4>
 <p className="text-xs text-muted-foreground mt-0.5">Shifts, Customers, Suppliers, Inventory</p>
 </div>
 </button>
 ...
 disabled={isExporting}
 className="w-full flex items-center gap-4 p-4 rounded-xl border border-border hover:border-orange-300 hover:bg-orange-50 transition-all text-left disabled:opacity-50 relative overflow-hidden"
 >
 ...
 <div>
 <h4 className="text-sm font-bold text-foreground">{t('Full Backup', 'مکمل بیک اپ')}</h4>
 <p className="text-xs text-muted-foreground mt-0.5">Everything included.</p>
 </div>
 </button>
 </div>
 </div>
 ...
 <div className="bg-card rounded-xl border border-border shadow-xs overflow-hidden flex flex-col">
 <div className="px-6 py-4 border-b border-border bg-subtle flex items-center gap-3">
 <div className="h-8 w-8 rounded-full bg-slate-200 flex items-center justify-center text-muted-foreground">
 <UploadCloud className="h-4 w-4" />
 </div>
 <h3 className="text-base font-bold text-foreground">{t('Restore Backup', 'بیک اپ بحال کریں')}</h3>
 </div>
 
 <div className="p-6 flex-1 flex flex-col items-center justify-center border-2 border-dashed border-border m-6 rounded-xl bg-subtle relative">
 <input 
 type="file" 
 accept=".fuelpro"
 ref={fileInputRef}
 ...
 <h4 className="text-sm font-bold text-foreground truncate px-4">{restoreFile.name}</h4>
 ...
 className="w-full px-4 py-2.5 sm:py-2 min-h-[48px] sm:min-h-[40px] bg-card text-foreground rounded-lg text-sm font-bold shadow-xs hover:bg-slate-800 transition-colors disabled:opacity-70"
 >
 ...
 disabled={isRestoring}
 className="w-full px-4 py-2 bg-card text-muted-foreground border border-border rounded-lg text-sm font-bold shadow-xs hover:bg-slate-50 transition-colors disabled:opacity-70"
 >
 {t('Cancel', 'کینسل')}
 </button>
 </div>
 ...
 <h4 className="text-sm font-bold text-foreground">{t('Select .fuelpro File', '.fuelpro فائل منتخب کریں')}</h4>
 ...
 className="mt-6 px-6 py-2.5 bg-card border border-border text-foreground rounded-lg text-sm font-bold shadow-xs hover:bg-slate-50 transition-all hover:border-slate-400"
 >
