...
export default function DataIntegrity({ settings, activeStationId, onNavigate }: DataIntegrityProps) {
 ...
 <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-card/10 border border-border rounded-full text-xs font-bold text-indigo-200">
 ...
 <div className="text-2xl font-black text-foreground">{stats?.validatedShifts || 0}</div>
 </div>
