...
export default function ProfileCenter({ settings }: { settings: GlobalSettings }) {
 ...
 <h2 className="text-lg font-bold text-foreground">{t('Profile Center', 'پروفائل سینٹر')}</h2>
 ...
 <div className="w-20 h-20 bg-card rounded-full border-4 border-border shadow-md flex items-center justify-center">
 <div className="w-full h-full bg-muted rounded-full flex items-center justify-center">
 <User className="h-9 w-9 text-muted-foreground" />
 </div>
 </div>
 <button className="absolute bottom-0 right-0 p-1.5 bg-card border border-border rounded-full text-muted-foreground hover:text-orange-600 shadow-sm transition-colors">
 <Edit3 className="h-3 w-3" />
 </button>
 </div>
 <h3 className="mt-3 text-base font-bold text-foreground text-center">{fullName}</h3>
 <p className="text-xs text-muted-foreground text-center truncate max-w-full px-2">{user.email}</p>
 ...
 <h4 className="text-[10px] font-extrabold text-muted-foreground uppercase tracking-widest mb-3">
 ...
 <p className="text-xs font-bold text-foreground truncate">{session.deviceName}</p>
 <p className="text-[11px] text-muted-foreground break-all leading-tight mt-0.5">{session.browser}</p>
 </div>
 </div>
 <div className="flex items-start gap-2.5">
 <Globe className="h-4 w-4 text-muted-foreground mt-0.5 shrink-0" />
 <div className="min-w-0">
 <p className="text-xs font-bold text-foreground">{session.ipHistory[0]}</p>
 <p className="text-[11px] text-muted-foreground mt-0.5">{t('Current IP Address', 'موجودہ IP')}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-sm font-bold text-foreground">{t('Personal Information', 'ذاتی معلومات')}</h3>
 {!isEditing && (
 <button
 ...
 disabled={!isEditing}
 className="w-full pl-9 pr-3 py-2.5 bg-subtle border border-border rounded-xl text-sm font-semibold text-foreground focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400 disabled:opacity-60 disabled:bg-muted transition-all"
 />
 </div>
 </div>
 ...
 value={user.email}
 disabled
 className="w-full pl-9 pr-3 py-2.5 bg-muted border border-border rounded-xl text-sm font-semibold text-muted-foreground cursor-not-allowed truncate"
 />
 </div>
 </div>
 ...
 disabled
 className="w-full pl-9 pr-3 py-2.5 bg-muted border border-border rounded-xl text-sm font-semibold text-muted-foreground cursor-not-allowed"
 />
 </div>
 </div>
 </div>
 ...
 className="px-4 py-2 text-sm font-bold text-muted-foreground bg-muted rounded-xl hover:bg-slate-200 transition-colors cursor-pointer"
 >
 {t('Cancel', 'کینسل')}
 </button>
 <button
 ...
 <h3 className="text-sm font-bold text-foreground">{t('Authentication', 'آتھنٹیکیشن')}</h3>
 </div>
 ...
 <div className="min-w-0">
 <h4 className="text-sm font-bold text-foreground">{t('Account Password', 'اکاؤنٹ کا پاس ورڈ')}</h4>
 ...
 className="w-full sm:w-auto shrink-0 px-4 py-2.5 bg-card border border-border text-foreground text-sm font-bold rounded-xl hover:bg-slate-50 hover:border-slate-400 transition-all cursor-pointer text-center"
 >
 ...
 <h4 className="text-sm font-bold text-foreground">{t('Two-Factor Authentication', 'دوہری تصدیق')}</h4>
 {user.totpEnabled && (
 ...
 user.totpEnabled
 ? 'bg-card border border-border text-slate-700 hover:bg-red-50 hover:text-red-600 hover:border-red-200'
 ...
 <h3 className="text-sm font-bold text-foreground">{t('About FuelPro', 'فیول پرو کے بارے میں')}</h3>
 </div>
 ...
 <div>
 <p className="text-sm font-bold text-foreground">FuelPro Enterprise</p>
 <p className="text-xs text-muted-foreground">Version 3.0 · Gold Medal Edition</p>
 </div>
 </div>
 ...
 <span className="text-xs text-muted-foreground">{t('Developed by', 'بنانے والا')}</span>
