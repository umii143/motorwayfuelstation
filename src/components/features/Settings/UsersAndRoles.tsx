...
export default function UsersAndRoles({ settings }: { settings: GlobalSettings }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#151521] rounded-xl border border-slate-200 dark:border-white/10 shadow-xs p-8 text-center max-w-2xl mx-auto">
        <div className="w-16 h-16 bg-indigo-50 rounded-full flex items-center justify-center mx-auto mb-4">
          <Shield className="h-8 w-8 text-indigo-500" />
        </div>
        <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-2">Centralized Staff Management</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-sm mx-auto text-left">
          <div className="bg-slate-50 dark:bg-white/5 p-3 rounded-lg border border-slate-100 dark:border-white/5 flex items-center gap-3">
