...
export default function RateWizard({
 ...
 {/* RATES EDITOR CARDS */}
 <div className="bg-card rounded-3xl shadow-sm border border-border overflow-hidden mt-4">
 <div className="text-center border-b border-border p-6 bg-background">
 ...
 <div className="text-center py-6 text-muted-foreground bg-subtle /30 rounded-2xl border border-dashed border-border">
 {isLube 
 ...
 <div 
 key={product.id}
 className="p-5 border border-border rounded-2xl bg-card shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4"
 >
 ...
 <p className="text-sm text-muted-foreground font-medium">Rs. {product.rate} {isLube ? t('per Item', 'فی آئٹم', language) : t('per Liter', 'فی لیٹر', language)}</p>
 </div>
 </div>
 ...
 <label className="text-[10px] uppercase font-bold text-muted-foreground absolute -top-5 left-1 transition-opacity duration-300 opacity-0 group-focus-within:opacity-100">{t('Effective Date', 'تاریخ اور وقت', language)}</label>
 <input 
 type="datetime-local"
 ...
 className="w-full h-14 px-3 bg-background border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-card dark:focus:bg-[#1e293b] focus:border-emerald-500 transition-colors font-bold text-sm text-foreground"
 />
 </div>
 ...
 className="w-full h-14 pl-12 pr-4 bg-background border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-card dark:focus:bg-[#1e293b] focus:border-emerald-500 transition-colors font-bold text-lg text-foreground text-right"
 placeholder="0.00"
 />
 </div>
 ...
 <td className="text-muted-foreground">{displayDate}</td>
 <td>
