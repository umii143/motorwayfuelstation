...
function NotificationToggle({ icon: Icon, iconColor, title, description, checked, onChange }: NotificationToggleProps) {
 ...
 role="switch"
 >
 <span className={`inline-block h-4 w-4 transform rounded-full bg-card shadow-sm transition-transform duration-200${
...
export default function NotificationsConfig({
 ...
 <div className="px-5 py-3 border-b border-border bg-subtle">
 ...
 className="w-full max-w-xs px-3 py-2.5 bg-subtle border border-border rounded-xl text-sm text-foreground font-medium focus:outline-none focus:border-emerald-400 focus:ring-1 focus:ring-emerald-400 transition-all"
 />
 ...
 <button
 onClick={handleSave}
 className="flex items-center gap-2 px-6 py-2.5 bg-card hover:bg-slate-800 text-foreground rounded-xl text-sm font-bold shadow-sm transition-all cursor-pointer"
 >
