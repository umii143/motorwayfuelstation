...
export default function FactoryReset({ settings, activeStationId }: { settings: GlobalSettings, activeStationId: string }) {
 ...
 <h3 className="text-2xl font-bold text-foreground mb-4">{t('Are you absolutely sure?', 'کیا آپ کو پورا یقین ہے؟')}</h3>
 ...
 <div className="bg-subtle rounded-xl p-5 border border-border">
 <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">Records to Delete</p>
 <p className="text-3xl font-mono font-bold text-rose-600">{recordsCount.toLocaleString()}</p>
 <p className="text-sm text-muted-foreground mt-2">Transactions, Shifts, Customers, etc.</p>
 </div>
 
 <div className="bg-subtle rounded-xl p-5 border border-border">
 <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">Estimated Auto-Backup Size</p>
 <p className="text-3xl font-mono font-bold text-indigo-600">{estimatedSize}</p>
 <p className="text-sm text-muted-foreground mt-2">Will be generated before wiping.</p>
 </div>
 </div>
 ...
 <button 
 onClick={() => setStep(1)}
 className="px-6 py-2.5 bg-card border border-border text-muted-foreground rounded-lg font-bold hover:bg-slate-50 transition-colors"
 >
 {t('Cancel', 'کینسل')}
 </button>
 <button 
 ...
 <h3 className="text-xl font-bold text-foreground">{t('Final Authorization', 'حتمی اجازت')}</h3>
 <p className="text-sm text-muted-foreground mt-1">Please fulfill all security conditions to unlock the wipe button.</p>
 </div>
 ...
 placeholder="******"
 className="w-full pl-10 pr-3 py-3 bg-card border border-rose-200 rounded-lg text-lg font-mono font-bold text-foreground focus:border-rose-500 focus:ring-1 focus:ring-rose-500 tracking-widest text-center shadow-inner"
 />
 </div>
 </div>
 )}
 ...
 placeholder="000000"
 className="w-full px-3 py-3 bg-card border border-rose-200 rounded-lg text-lg font-mono font-bold text-foreground focus:border-rose-500 focus:ring-1 focus:ring-rose-500 tracking-widest text-center shadow-inner"
 />
 </div>
 )}
 ...
 className="w-full px-3 py-3 bg-card border border-rose-200 rounded-lg text-sm font-mono font-bold text-foreground focus:border-rose-500 focus:ring-1 focus:ring-rose-500 text-center shadow-inner"
 />
 </div>
 ...
 <h3 className="text-2xl font-bold text-foreground mb-2">{t('Wiping Data...', 'ڈیٹا حذف ہو رہا ہے...')}</h3>
 <p className="text-muted-foreground">{t('Please do not close this window.', 'براہ کرم اس ونڈو کو بند نہ کریں۔')}</p>
 </div>
 )}
 </div>
 </div>
