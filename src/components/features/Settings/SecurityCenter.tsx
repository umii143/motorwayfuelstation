...
export default function SecurityCenter({ settings, onUpdateSettings }: SecurityCenterProps) {
 ...
 if (pinMode === 'idle') {
 return (
 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-subtle border border-border rounded-xl gap-4">
 ...
 className="w-full sm:w-auto px-4 py-2 premium-card border text-foreground hover:bg-slate-50 text-xs font-bold transition-colors"
 >
 ...
 className="w-full sm:w-auto px-4 py-2 bg-card text-foreground hover:bg-slate-800 rounded-lg text-xs font-bold transition-colors shadow-sm"
 >
 ...
 className={`p-3 text-sm font-bold border rounded-lg flex flex-col items-center justify-center gap-2 transition-all${forgotMethod === 'password' ? 'bg-card border-rose-500 shadow-sm text-rose-700' : 'bg-card/50 border-rose-200 text-rose-600 hover:bg-card'}`}
 >
 ...
 className={`p-3 text-sm font-bold border rounded-lg flex flex-col items-center justify-center gap-2 transition-all${forgotMethod === 'email' ? 'bg-card border-rose-500 shadow-sm text-rose-700' : 'bg-card/50 border-rose-200 text-rose-600 hover:bg-card'}`}
 >
 ...
 className="w-full pl-3 pr-10 py-2.5 bg-card border border-rose-200 rounded-lg text-sm text-foreground focus:border-rose-500 focus:ring-1 focus:ring-rose-500 shadow-inner"
 />
 <button type="button" onClick={() => setShowPin(!showPin)} className="absolute inset-y-0 right-0 pr-3 flex items-center text-muted-foreground">
 ...
 className="w-full px-3 py-2.5 bg-card border border-rose-200 rounded-lg text-sm text-foreground focus:border-rose-500 text-center font-mono tracking-widest shadow-inner"
 />
 <button
 type="button"
 onClick={handleForgotPinVerify}
 ...
 return (
 <div className="p-5 bg-card border border-border shadow-sm rounded-xl space-y-4 animate-in fade-in slide-in-from-top-4">
 <div className="flex items-center justify-between">
 <h4 className="font-bold text-foreground flex items-center gap-2">
 <Key className="h-5 w-5 text-indigo-500" />
 {pinMode === 'setup' ? t('Setup New Master PIN', 'نیا ماسٹر پن سیٹ کریں') : t('Change Master PIN', 'ماسٹر پن تبدیل کریں')}
 </h4>
 <button onClick={cancelPinMode} className="text-muted-foreground hover:text-slate-600"><X className="h-5 w-5" /></button>
 </div>

 <div className="space-y-4">
 {pinMode === 'change' && (
 <div className="space-y-1">
 <label className="text-xs font-bold text-muted-foreground uppercase">{t('Current PIN', 'موجودہ پن')}</label>
 <div className="relative">
 <input
 type={showPin ?"text" :"password"}
 maxLength={6}
 ...
 placeholder="******"
 className="w-full px-3 py-2.5 bg-subtle border border-border rounded-lg text-lg font-mono font-bold text-foreground focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-inner tracking-widest text-center"
 />
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold text-muted-foreground uppercase">{t('New PIN', 'نیا پن')}</label>
 <input
 type={showPin ?"text" :"password"}
 maxLength={6}
 value={newPin}
 ...
 placeholder="******"
 className="w-full px-3 py-2.5 bg-subtle border border-border rounded-lg text-lg font-mono font-bold text-foreground focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 shadow-inner tracking-widest text-center"
 />
 </div>
 <div className="space-y-1">
 <label className="text-xs font-bold text-muted-foreground uppercase">{t('Confirm New PIN', 'نئے پن کی تصدیق کریں')}</label>
 <input
 type={showPin ?"text" :"password"}
 maxLength={6}
 value={confirmPin}
 ...
 <button type="button" onClick={() => setShowPin(!showPin)} className="flex items-center gap-1.5 text-xs font-bold text-muted-foreground hover:text-slate-700">
 {showPin ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
 ...
 className="px-6 py-3 sm:py-2 min-h-[48px] sm:min-h-[40px] bg-card text-foreground rounded-lg text-sm font-bold shadow-xs hover:bg-slate-800 disabled:opacity-50 transition-colors"
 >
 ...
 <div>
 <h2 className="text-xl font-bold text-foreground">{t('Security Center', 'سیکیورٹی سینٹر')}</h2>
 ...
 className="px-4 py-2 bg-card text-foreground rounded-lg text-sm font-bold shadow-xs hover:bg-slate-800 transition-colors"
 >
 ...
 <h3 className="text-base font-bold text-foreground">{t('Master PIN Control', 'ماسٹر پن کنٹرول')}</h3>
 </div>
 <div className="p-6">
 {renderPinManagement()}
 </div>
 ...
 <div className="bg-card rounded-xl border border-border shadow-xs overflow-hidden">
 <div className="px-6 py-4 border-b border-border flex items-center gap-2 bg-subtle">
 <Shield className="h-5 w-5 text-muted-foreground" />
 <h3 className="text-base font-bold text-foreground">{t('Enforcement & Policies', 'نفاذ اور پالیسیاں')}</h3>
 </div>

 <div className="p-6 space-y-6">
 <div>
 <h4 className="text-sm font-bold text-foreground mb-4">{t('PIN Enforcement', 'پن کا نفاذ')}</h4>
 <div className="space-y-4">
 ...
 />
 <div className="h-5 w-5 rounded border border-border bg-card peer-checked:bg-slate-900 peer-checked:border-slate-900 flex items-center justify-center transition-all group-hover:border-slate-400">
 ...
 <div>
 <span className="text-sm font-bold text-foreground block">{t('Require PIN for Meter Resets', 'میٹر ری سیٹ کے لیے پن لازمی کریں')}</span>
 <span className="text-xs text-muted-foreground block mt-0.5">Prevents unauthorized modification of dispenser readings.</span>
 </div>
 </label>
 ...
 <div>
 <span className="text-sm font-bold text-foreground block">{t('Require PIN for Factory Reset', 'فیکٹری ری سیٹ کے لیے پن لازمی کریں')}</span>
 <span className="text-xs text-muted-foreground block mt-0.5">Absolute requirement to wipe system data.</span>
 </div>
 </label>
 </div>
 </div>
 ...
 <h4 className="text-sm font-bold text-foreground mb-4">{t('Screen Lock Settings', 'سکرین لاک سیٹنگز')}</h4>
 ...
 <Lock className="h-5 w-5 text-muted-foreground" />
 <span className="text-sm font-bold text-foreground">{t('Enable Screen Lock', 'سکرین لاک فعال کریں')}</span>
 </div>
 </label>
 ...
 />
 <div className={`w-11 h-6 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-card after:border-border after:border after:rounded-full after:h-5 after:w-5 after:transition-all${!isEditing || !screenLockEnabled ? 'bg-muted' : 'bg-slate-200 peer-checked:bg-emerald-500'}`}></div>
 </div>
 <div className={`flex items-center gap-2${!screenLockEnabled ? 'opacity-50' : ''}`}>
 <Fingerprint className="h-5 w-5 text-muted-foreground" />
 <span className="text-sm font-bold text-foreground">{t('Biometric Unlock', 'بائیو میٹرک انلاک')}</span>
 </div>
 </label>
 </div>
 ...
 <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider">{t('Auto-Lock Timeout', 'آٹو لاک ٹائم آؤٹ')}</label>
 <div className="relative">
 ...
 disabled={!isEditing || !screenLockEnabled}
 className="w-full pl-10 pr-3 py-2 bg-subtle border border-border rounded-lg text-sm font-semibold text-foreground focus:border-slate-500 disabled:opacity-70"
 >
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider">{t('Screen Lock PIN', 'سکرین لاک پن')}</label>
 <input
 type="password"
 maxLength={6}
 value={screenLockPin}
 ...
 disabled={!isEditing}
 placeholder="******"
 className="w-full px-3 py-2 bg-subtle border border-border rounded-lg text-sm font-semibold text-foreground focus:border-slate-500 disabled:opacity-70 tracking-widest"
 />
 </div>
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider">{t('Confirm PIN', 'پن کی تصدیق کریں')}</label>
 <input
 type="password"
 maxLength={6}
 ...
 className="px-4 py-2 text-sm font-bold text-muted-foreground bg-card border border-border rounded-lg hover:bg-muted transition-colors"
 >
 {t('Cancel', 'کینسل')}
 </button>
 <button
 type="submit"
 className="px-5 py-2 text-sm font-bold text-foreground bg-card rounded-lg hover:bg-slate-800 transition-colors flex items-center gap-2 shadow-xs"
 >
