...
export default function SecurityCenter({ settings, onUpdateSettings }: SecurityCenterProps) {
  ...
  const renderPinManagement = () => {
    if (pinMode === 'idle') {
      return (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl gap-4">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            {hasMasterPin ? (
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 premium-card border text-slate-700 hover:bg-slate-50 dark:bg-white/5 text-xs font-bold transition-colors"
              >
        ...
        <div className="p-5 bg-rose-50 border border-rose-200 rounded-xl space-y-4 animate-in fade-in slide-in-from-top-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className={`p-3 text-sm font-bold border rounded-lg flex flex-col items-center justify-center gap-2 transition-all ${forgotMethod === 'password' ? 'bg-white dark:bg-[#151521] border-rose-500 shadow-sm text-rose-700' : 'bg-white dark:bg-[#151521]/50 border-rose-200 text-rose-600 hover:bg-white dark:bg-[#151521]'}`}
            >
            ...
            <button
              ...
              className={`p-3 text-sm font-bold border rounded-lg flex flex-col items-center justify-center gap-2 transition-all ${forgotMethod === 'email' ? 'bg-white dark:bg-[#151521] border-rose-500 shadow-sm text-rose-700' : 'bg-white dark:bg-[#151521]/50 border-rose-200 text-rose-600 hover:bg-white dark:bg-[#151521]'}`}
            >
            ...
            <div className="space-y-3 pt-3">
              <div className="relative">
                <input 
                  ...
                  className="w-full pl-3 pr-10 py-2.5 bg-white dark:bg-[#151521] border border-rose-200 rounded-lg text-sm text-slate-800 dark:text-slate-200 focus:border-rose-500 focus:ring-1 focus:ring-rose-500 shadow-inner"
                />
    ...
    return (
      <div className="p-5 bg-white dark:bg-[#151521] border border-slate-200 dark:border-white/10 shadow-sm rounded-xl space-y-4 animate-in fade-in slide-in-from-top-4">
        <div className="flex items-center justify-between">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="******"
                  className="w-full px-3 py-2.5 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg text-lg font-mono font-bold text-slate-800 dark:text-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-inner tracking-widest text-center"
                />
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input 
                ...
                placeholder="******"
                className="w-full px-3 py-2.5 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg text-lg font-mono font-bold text-slate-800 dark:text-slate-200 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 shadow-inner tracking-widest text-center"
              />
            </div>
            <div className="space-y-1">
  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-slate-200 dark:border-white/10 pb-4 flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">{t('Security Center', 'سیکیورٹی سینٹر')}</h2>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-[#151521] rounded-xl border border-slate-200 dark:border-white/10 shadow-xs overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-200 dark:border-white/10 flex items-center gap-2">
              ...
              <h3 className="text-base font-bold text-slate-800 dark:text-slate-200">{t('Master PIN Control', 'ماسٹر پن کنٹرول')}</h3>
            </div>
            <div className="p-6">
              {renderPinManagement()}
            </div>
          ...
          <form onSubmit={handleGeneralSave}>
            <div className="bg-white dark:bg-[#151521] rounded-xl border border-slate-200 dark:border-white/10 shadow-xs overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-200 dark:border-white/10 flex items-center gap-2 bg-slate-50 dark:bg-white/5/50">
                  ...
                  <div className="space-y-4">
                    <label className="flex items-start gap-3 cursor-pointer group">
                      <div className="relative flex items-start pt-0.5">
                        ...
                        />
                        <div className="h-5 w-5 rounded border border-slate-300 bg-white dark:bg-[#151521] peer-checked:bg-slate-900 peer-checked:border-slate-900 flex items-center justify-center transition-all group-hover:border-slate-400">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                      ...
                      <label className="flex items-center gap-3 cursor-pointer">
                        <div className="relative">
                          ...
                          />
                          <div className={`w-11 h-6 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white dark:bg-[#151521] after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all ${!isEditing || !screenLockEnabled ? 'bg-slate-100 dark:bg-white/10' : 'bg-slate-200 peer-checked:bg-emerald-500'}`}></div>
                        </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <select 
                            ...
                            disabled={!isEditing || !screenLockEnabled}
                            className="w-full pl-10 pr-3 py-2 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg text-sm font-semibold text-slate-800 dark:text-slate-200 focus:border-slate-500 disabled:opacity-70"
                          >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-50">
                        <div className="space-y-1.5">
                          ...
                          <input 
                            ...
                            disabled={!isEditing}
                            placeholder="******"
                            className="w-full px-3 py-2 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg text-sm font-semibold text-slate-800 dark:text-slate-200 focus:border-slate-500 disabled:opacity-70 tracking-widest"
                          />
                        </div>
                        <div className="space-y-1.5">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-[#151521] rounded-xl border border-slate-200 dark:border-white/10 shadow-xs p-6">
