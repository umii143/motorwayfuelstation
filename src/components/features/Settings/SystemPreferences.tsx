      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs max-w-2xl p-6 space-y-6">
        <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
          <div className="space-y-1.5">
            ...
            <select name="language" value={prefs.language} onChange={handleChange} className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-800">
          ...
          <div className="space-y-1.5">
            ...
            <select name="currency" value={prefs.currency} onChange={handleChange} className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-800">
          ...
          <div className="space-y-1.5">
            ...
            <select name="receiptPrinter" value={prefs.receiptPrinter} onChange={handleChange} className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-800">
        ...
        <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
          <button onClick={handleSave} className="px-6 py-2.5 bg-slate-900 text-white rounded-lg text-sm font-bold flex items-center gap-2 hover:bg-slate-800 transition-colors cursor-pointer">
      ...
      <div className="bg-red-50 rounded-xl border border-red-200 shadow-xs max-w-2xl p-6 space-y-4">
        ...
        <div className="pt-2">
          <button 
            ...
            className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-bold flex items-center gap-2 transition-colors cursor-pointer shadow-md"
          >
