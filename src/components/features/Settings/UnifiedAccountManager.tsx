      ...
      {subTab === 'banks' && (
        <div className="space-y-4">
          ...
          {showBankForm ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 p-4 rounded-xl border border-emerald-250 bg-emerald-50/5 animate-fade-in">
      ...
      {subTab === 'digital' && (
        <div className="space-y-4">
          ...
          {showWalletForm ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 p-4 rounded-xl border border-violet-250 bg-violet-50/5 animate-fade-in">
      ...
      {subTab === 'products' && (
        <div className="space-y-4">
          ...
          {showProductForm ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 p-4 rounded-xl border border-orange-250 bg-orange-50/5 animate-fade-in">
              ...
              <div className="rounded-xl border border-dashed border-slate-250 p-4 bg-slate-50 flex flex-col justify-between select-none font-sans text-xs text-slate-650 h-56 self-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 border-t border-dashed border-slate-200 pt-3">
                  <div>
