      ...
      {subTab === 'banks' && (
        <div className="space-y-4">
          ...
          {showBankForm ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-xl border border-emerald-250 bg-emerald-50/5 animate-fade-in">
      ...
      {subTab === 'digital' && (
        <div className="space-y-4">
          ...
          {showWalletForm ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-xl border border-violet-250 bg-violet-50/5 animate-fade-in">
      ...
      {subTab === 'products' && (
        <div className="space-y-4">
          ...
          {showProductForm ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-xl border border-orange-250 bg-orange-50/5 animate-fade-in">
