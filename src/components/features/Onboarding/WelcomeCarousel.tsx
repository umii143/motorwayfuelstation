...
export const WelcomeCarousel: React.FC<WelcomeCarouselProps> = ({ language, onComplete }) => {
 ...
 return (
 <div className="fixed inset-0 z-[9000] bg-background flex flex-col overflow-hidden">
 ...
 <div className="absolute inset-0 bg-card/20 blur-xl rounded-full mix-blend-overlay" />
 ...
 idx === currentSlide ? 'w-8 bg-orange-500' : 'w-2 bg-card'
 }`}
 />
 ))}
 </div>
