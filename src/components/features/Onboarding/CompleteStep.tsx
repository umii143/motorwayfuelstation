...
export function CompleteStep({ onFinish, language }: Props) {
 ...
 <div className="max-w-2xl w-full bg-card rounded-3xl shadow-xl border border-border overflow-hidden text-center p-12 space-y-8">
 ...
 <button
 onClick={onFinish}
 className="w-full md:w-auto md:px-16 py-4 bg-card hover:bg-slate-900 text-foreground rounded-xl font-black text-lg transition-all shadow-xl hover:shadow-slate-900/30 active:scale-95 cursor-pointer flex items-center justify-center gap-3 mx-auto"
 >
