...
export function WelcomeStep({ onContinue, onCancel, language }: Props) {
 ...
 <div className="max-w-2xl w-full bg-card rounded-3xl shadow-xl border border-border overflow-hidden">
 ...
 <div className="space-y-4 text-left max-w-md mx-auto bg-subtle p-6 rounded-2xl border border-border">
 ...
 <span className="font-semibold text-foreground">{t('1. Add Fuel Products', '1. فیول پراڈکٹس شامل کریں', language)}</span>
 </div>
 <div className="flex items-center gap-4">
 ...
 <span className="font-semibold text-foreground">{t('2. Add Tanks', '2. ٹینکس شامل کریں', language)}</span>
 </div>
 <div className="flex items-center gap-4">
 ...
 <span className="font-semibold text-foreground">{t('3. Add Nozzles', '3. نوزلز شامل کریں', language)}</span>
 </div>
 <div className="flex items-center gap-4">
 ...
 <span className="font-semibold text-foreground">{t('4. Set Fuel Rates', '4. فیول ریٹس مقرر کریں', language)}</span>
 </div>
 </div>
 </div>

 <div className="pt-6">
 <p className="text-sm font-bold text-muted-foreground mb-6 flex items-center justify-center gap-2">
 ...
 <button 
 onClick={onCancel}
 className="w-full md:w-auto mt-4 px-8 py-3 text-muted-foreground hover:text-slate-700 font-bold transition-colors cursor-pointer"
 >
