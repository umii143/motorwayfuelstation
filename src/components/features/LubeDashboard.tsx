...
export default React.memo(function LubeDashboard({
 ...
 const themeWrap ="min-h-screen bg-background text-foreground font-sans selection:bg-orange-500/30 overflow-x-hidden pb-32 relative transition-colors duration-500";
 
 // Layer 1: Base components (Hero, Command Centers) -> 75% Dark, 25% Contrast
 const glassLayer1 ="backdrop-blur-[40px] bg-card/70 dark:bg-white/[0.04] border border-border/60 dark:border-white/[0.08] shadow-[0_20px_80px_rgba(0,0,0,0.05)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_20px_80px_rgba(0,0,0,0.4)] rounded-[32px] relative overflow-hidden transition-all duration-300";
 
 // THE 10/10 LIQUID GLASS KPI CAPSULE
 const liquidGlass ="relative overflow-hidden backdrop-blur-[30px] saturate-[150%] bg-card/65 dark:bg-transparent dark:bg-gradient-to-br dark:from-white/[0.08] dark:to-white/[0.02] border border-white/80 dark:border-white/[0.08] shadow-[0_20px_60px_rgba(15,23,42,0.08)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_20px_80px_rgba(0,0,0,0.6)] rounded-[32px] transition-all duration-500 group";
 ...
 const glassLayer3 ="backdrop-blur-[20px] bg-muted/50 dark:bg-white/[0.02] border border-border/50 dark:border-white/[0.04] shadow-[inset_0_2px_4px_rgb(0,0,0,0.02)] dark:shadow-[inset_0_4px_8px_rgba(0,0,0,0.6)] rounded-[24px] transition-colors duration-300";

 // Dock Layer
 const dockLayer ="hidden lg:flex fixed bottom-6 left-1/2 -translate-x-1/2 backdrop-blur-[60px] bg-card/80 /80 border border-border/60 dark:border-white/[0.15] shadow-[0_20px_80px_rgb(0,0,0,0.15)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_40px_100px_rgba(0,0,0,0.9)] rounded-[2rem] px-3 py-3 items-center gap-1 z-[100] transition-transform duration-300 hover:scale-[1.02] transform-gpu";

 const textSubtle ="text-muted-foreground";
 const textPrimary ="text-foreground";
 const textValue ="text-foreground";
 ...
 <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-500/20 rounded-full blur-[140px] mix-blend-multiply dark:mix-blend-screen animate-pulse duration-[8000ms]"></div>
 <div className="absolute top-[20%] right-[-10%] w-[30%] h-[50%] bg-orange-500/20 rounded-full blur-[160px] mix-blend-multiply dark:mix-blend-screen"></div>
 <div className="absolute bottom-[-10%] left-[20%] w-[50%] h-[40%] bg-indigo-500/20 rounded-full blur-[140px] mix-blend-multiply dark:mix-blend-screen"></div>
 </div>
 ...
 <button className="flex items-center gap-2 px-4 py-2.5 bg-card/50 hover:bg-card/80 dark:hover:bg-card/[0.1] border border-border rounded-full text-sm font-semibold transition-colors backdrop-blur-xl shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 <span className={textPrimary}>Branch: Main</span>
 <ChevronDown className={`w-4 h-4${textSubtle}`} />
 </button>
 <button className="p-2.5 bg-card/50 hover:bg-card/80 dark:hover:bg-card/[0.1] border border-border rounded-full transition-colors backdrop-blur-xl relative shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 <Bell className={`w-4 h-4 text-muted-foreground`} />
 {stats.alerts.length > 0 && (
 <span className="absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-border shadow-[0_0_10px_rgba(239,68,68,0.5)]"></span>
 )}
 </button>
 </div>
 </motion.header>
 ...
 <div className="px-3 py-1 bg-card/50 rounded-full border border-border text-[10px] font-bold text-muted-foreground shadow-sm dark:shadow-inner flex items-center gap-1.5">
 ...
 <div className={`text-3xl sm:text-4xl font-black tracking-tight text-emerald-600 drop-shadow-sm dark:drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]`}>
 ...
 {stats.todayOrders} <span className="text-lg text-muted-foreground font-medium">orders</span>
 </div>
 </div>
 </div>
 
 <div className="mt-8 pt-6 border-t border-border grid grid-cols-1 sm:grid-cols-3 gap-8 relative z-10">
 <div className="flex items-center gap-3">
 ...
 <div className="flex items-center gap-3">
 <div className="relative w-10 h-10 flex items-center justify-center bg-indigo-50 rounded-full border border-indigo-200 shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 ...
 <div className="text-[10px] font-black text-indigo-600">{stats.healthyPct}%</div>
 </div>
 <div>
 ...
 <div className="flex items-center gap-3">
 <div className="p-2.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-600 flex items-center justify-center shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 ...
 <Zap className="w-4 h-4 text-indigo-500 relative z-10" />
 ...
 <div className="w-16 h-16 bg-muted border border-border rounded-full flex items-center justify-center mx-auto mb-4 shadow-inner dark:shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
 ...
 <div className="p-2 bg-card/80 border border-border rounded-[14px] text-muted-foreground shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]"><Wallet className="w-4 h-4" /></div>
 </div>
 ...
 <div className="px-2 py-0.5 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-[10px] font-bold text-emerald-600 flex items-center gap-1">
 ...
 <Suspense fallback={<div className="w-full h-full animate-pulse bg-card/5"></div>}>
 ...
 <div className="p-2 bg-card/80 border border-border rounded-[14px] text-amber-500 shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]"><Briefcase className="w-4 h-4" /></div>
 </div>
 <div className="relative z-10 flex flex-col items-start gap-1">
 <div className={`text-3xl font-black drop-shadow-sm dark:drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]${textValue}`}>
 {formatCurrency(stats.totalReceivables, settings)}
 </div>
 <div className="px-2 py-0.5 rounded-md bg-amber-500/10 border border-amber-500/20 text-[10px] font-bold text-amber-600 flex items-center gap-1">
 ...
 <div className="p-2 bg-card/80 border border-border rounded-[14px] text-indigo-500 shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]"><PackageOpen className="w-4 h-4" /></div>
 </div>
 <div className="relative z-10 flex flex-col items-start gap-1">
 <div className={`text-3xl font-black drop-shadow-sm dark:drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]${textValue}`}>
 {formatCurrency(stats.totalInvValue, settings)}
 </div>
 <div className="px-2 py-0.5 rounded-md bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-bold text-indigo-600 flex items-center gap-1">
 ...
 <div className="p-2 bg-card/80 border border-border rounded-[14px] text-emerald-500 shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]"><Activity className="w-4 h-4" /></div>
 </div>
 <div className="relative z-10 flex flex-col items-start gap-1">
 <div className={`text-3xl font-black drop-shadow-sm dark:drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]${textValue}`}>
 ...
 <DeferredWidget delay={300} className="md:col-span-4" skeleton={<div className={`h-[300px]${glassLayer1}animate-pulse bg-card/5`}></div>}>
 ...
 <span className="font-bold text-amber-600">{formatCurrency(stats.totalReceivables, settings)}</span>
 </div>
 <div className="flex justify-between items-center text-sm px-2">
 <span className={textSubtle}>Total Payables</span>
 <span className="font-bold text-red-600">{formatCurrency(stats.totalPayables, settings)}</span>
 </div>
 
 <div className="grid grid-cols-2 gap-3 pt-4 border-t border-border">
 <button onClick={() => onNavigate('customers')} className="py-2.5 rounded-xl bg-amber-50 text-amber-600 hover:bg-amber-100 dark:hover:bg-amber-500/20 border border-amber-200 text-xs font-bold transition-colors shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 Collect Dues
 </button>
 <button onClick={() => onNavigate('suppliers')} className="py-2.5 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 dark:hover:bg-red-500/20 border border-red-200 text-xs font-bold transition-colors shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 Pay Suppliers
 </button>
 </div>
 </div>
 ...
 <DeferredWidget delay={600} className="md:col-span-8" skeleton={<div className={`h-[300px]${glassLayer1}animate-pulse bg-card/5`}></div>}>
 <motion.div variants={itemVariant} className={`${glassLayer1}p-6 h-full`}>
 <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
 <div className="flex justify-between items-center mb-6">
 <h3 className={`text-sm font-bold flex items-center gap-2 drop-shadow-sm${textPrimary}`}>
 ...
 <div className="w-full h-[120px] flex flex-col items-center justify-center text-sm border border-dashed rounded-[24px] font-medium shadow-inner text-muted-foreground border-border bg-muted/50 /30">
 <Activity className="w-6 h-6 mb-2 opacity-50" />
 <span className="text-muted-foreground font-bold">No transaction history yet</span>
 <span className="text-xs mt-1">Create sales to unlock cash flow analytics.</span>
 </div>
 ) : (
 <div className="h-[210px] w-full">
 <Suspense fallback={<div className="w-full h-full flex items-center justify-center animate-pulse bg-muted/50 rounded-2xl"></div>}>
 ...
 <DeferredWidget delay={900} className="md:col-span-4 flex flex-col" skeleton={<div className={`h-[300px]${glassLayer1}animate-pulse bg-card/5`}></div>}>
 ...
 {stats.feed.length === 0 ? (
 <div className="w-full h-full min-h-[150px] flex flex-col items-center justify-center text-sm border border-dashed rounded-[24px] font-medium shadow-inner text-muted-foreground border-border bg-muted/50 /30">
 <Clock className="w-6 h-6 mb-2 opacity-50" />
 <span>No activity recorded today</span>
 </div>
 ) : (
 stats.feed.map((item, i) => (
 <div key={i} className="flex gap-4 group cursor-pointer hover:bg-slate-50 dark:hover:bg-card/[0.03] p-2 -m-2 rounded-xl transition-colors">
 ...
 {i !== stats.feed.length - 1 && <div className="w-px h-8 bg-slate-200 mt-2"></div>}
 </div>
 ...
 <DeferredWidget delay={900} className="md:col-span-8 flex flex-col" skeleton={<div className={`h-[300px]${glassLayer1}animate-pulse bg-card/5`}></div>}>
 ...
 <div className="col-span-2 w-full h-[150px] flex flex-col items-center justify-center text-sm border border-dashed rounded-[24px] font-medium shadow-inner text-muted-foreground border-border bg-muted/50 /30">
 <PackageOpen className="w-6 h-6 mb-2 opacity-50" />
 <span className="text-muted-foreground font-bold">No products sold today</span>
 </div>
 ) : (
 stats.topProductsToday.map((prod, idx) => (
 <div key={idx} className={`flex items-center gap-4 group${glassLayer3}p-3 rounded-2xl transition-colors cursor-pointer hover:bg-card/50 dark:hover:bg-card/[0.05]`}>
 <div className="text-lg font-black text-muted-foreground w-4 text-center group-hover:text-orange-500 transition-colors">#{idx+1}</div>
 <div className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center shrink-0 shadow-sm dark:shadow-inner">
 ...
 <div className="text-[10px] font-semibold text-emerald-600">{prod.qty} units sold</div>
 </div>
 ...
 <div className="mt-1 flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-emerald-600 text-sm font-bold shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 ...
 <div className="px-4 py-2 rounded-[14px] bg-card/50 border border-border text-xs font-black text-muted-foreground shadow-sm dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
 V2.5
 </div>
 </div>
 </motion.div>
