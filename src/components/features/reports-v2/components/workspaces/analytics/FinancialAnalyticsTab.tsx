    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-[var(--bg-card)] border border-[var(--border-main)] rounded-2xl p-4 shadow-sm">
          ...
          <div className="text-2xl font-black text-primary dark:text-primary font-mono mt-1">{formatCurrency(metrics.cashPosition)}</div>
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border-main)] rounded-2xl p-4 shadow-sm">
          ...
          <div className="text-xs text-primary dark:text-primary font-bold mt-1">100% Reconciled</div>
        </div>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border-main)] rounded-2xl p-5 shadow-md space-y-4">
        ...
        <div className="p-4 rounded-xl bg-[var(--bg-subtle)] border border-[var(--border-main)] space-y-3 font-mono text-xs">
          ...
          <div className="grid grid-cols-4 gap-2 text-center text-[10px] pt-2 border-t border-[var(--border-muted)]">
            <div className="p-2 rounded bg-primary/10 text-primary font-bold">{formatCurrency(metrics.grossRevenue)}</div>
            ...
            <div className="p-2 rounded bg-primary/10 text-primary font-bold">{formatCurrency(metrics.netProfit)} Net Profit</div>
          </div>
        </div>
      </div>
    </div>
