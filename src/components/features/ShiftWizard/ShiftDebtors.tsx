...
export function ShiftDebtors({
 ...
 <h3 className="font-sans text-sm font-bold text-foreground border-b border-border pb-2 mb-4 flex items-center gap-2">
 ...
 {showQuickCustomer ? (
 <form onSubmit={handleQuickAddCustomer} className="flex gap-2 bg-card p-2 rounded-lg border border-border">
 <input
 autoFocus
 type="text"
 ...
 className="w-full rounded-md border border-border bg-card px-2.5 py-1.5 font-sans text-xs text-foreground focus:border-rose-500 outline-none"
 />
 <button
 type="submit"
 ...
 className="bg-muted text-muted-foreground px-3 py-1.5 rounded-md font-bold text-[10px] uppercase hover:bg-slate-600 transition-colors"
 >
 X
 </button>
 </form>
 ...
 className="w-full rounded-md border border-border bg-card px-3 py-2 font-sans text-xs text-foreground focus:border-rose-500 focus:bg-slate-800 outline-none transition-colors"
 >
 <option value="">
 {t("-- Select --","-- منتخب کریں --")}
 </option>
 ...
 className="w-full rounded-md border border-border bg-card px-3 py-2 font-mono text-sm text-rose-400 focus:border-rose-500 focus:bg-slate-800 outline-none transition-colors"
 />
 </div>
 ...
 <div className="mt-4 flex justify-between items-center bg-card p-3 rounded-lg border border-border">
 ...
 <h4 className="font-sans text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-3">
 {t("Added Debits This Shift:","اس شفٹ میں شامل کردہ قرضے:")}
 </h4>
 {activeShift.debitEntries.length === 0 ? (
 <p className="text-center py-6 font-sans text-xs text-muted-foreground border border-border border-dashed rounded-xl bg-card">
 ...
 <div
 key={d.id}
 className="flex justify-between items-center text-xs p-3 rounded-xl border border-border bg-card hover:bg-slate-800/80 transition-colors"
 >
 <div className="font-sans text-muted-foreground pr-4">
 <span className="font-bold text-foreground">{cName}</span> <span className="text-muted-foreground">—</span>{""}
