...
export function OpeningReadingsForm({
 ...
 return (
 <div className="rounded-2xl border border-border bg-card backdrop-blur-xl p-6 shadow-2xl relative overflow-hidden">
 ...
 className="bg-muted text-foreground px-4 py-2.5 rounded-xl text-sm font-bold shadow-md hover:bg-slate-600 transition-all flex items-center justify-center gap-2 active:scale-95 border border-border"
 >
 ...
 <div className={`px-2.5 py-1 rounded-md text-xs font-bold${theme.badgeBg}${theme.badgeText}ml-auto shadow-sm border border-border`}>
 ...
 <span className="flex items-center gap-1 text-[10px] font-bold text-muted-foreground bg-card px-2 py-0.5 rounded-full border border-border">
 ...
 <input
 type="number"
 className={`w-full bg-card border border-border rounded-lg px-3 py-3 text-lg font-mono font-bold text-foreground shadow-inner outline-none transition-all${theme.inputRing}${isMatching ? 'focus:border-emerald-500 focus:ring-emerald-500' : ''}`}
 placeholder="0.00"
 value={currentVal ||""}
 ...
 <span className="text-muted-foreground font-medium">Previous Close:</span>
 ...
 className="w-full sm:w-auto px-5 py-2.5 text-muted-foreground hover:text-slate-200 hover:bg-slate-700 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all border border-transparent hover:border-slate-600"
 >
...
export function ClosingReadingsForm({
 ...
 <input
 type="number"
 className={`w-full bg-card border${isError ? 'border-red-500 focus:ring-red-500 focus:border-red-500 text-red-400' : 'border-slate-700 text-slate-200 ' + theme.inputRing}rounded-lg px-3 py-3 text-xl font-mono font-black shadow-inner outline-none transition-all`}
 ...
 <span className="text-muted-foreground font-semibold text-[10px] uppercase">Opening</span>
 <span className="font-mono font-bold text-muted-foreground">{opening.toLocaleString()}</span>
 </div>
 {hasInput && !isError && (
 <div className="flex flex-col items-end">
 <span className="text-muted-foreground font-semibold text-[10px] uppercase">Amount</span>
