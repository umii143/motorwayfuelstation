...
"success"
 ...
 className="w-full rounded-md border border-border bg-card px-3 py-2 font-sans text-xs text-foreground focus:border-red-500 focus:bg-slate-800 outline-none transition-colors"
 >
 ...
 className="w-full rounded-md border border-orange-500/30 bg-card px-3 py-2 font-sans text-xs text-foreground focus:border-orange-500 font-medium outline-none transition-colors"
 >
 <option value="">
 {t("-- Choose --","-- منتخب کریں --")}
 </option>
 ...
 className="w-full rounded-md border border-border bg-card px-3 py-2 font-mono text-sm text-red-400 focus:border-red-500 focus:bg-slate-800 outline-none transition-colors"
 />
 </div>
 ...
 :"border-slate-700 bg-card/50 text-slate-400 hover:bg-card"
 }`}
 >
 💸 {t("Cash","کیش")}
 </button>
...
"ابھی کوئی خرچہ درج نہیں۔",
 ...
 >
 <div className="font-sans text-muted-foreground pr-4 flex-1 flex flex-wrap items-center gap-2">
