...
export function DashboardAIInsights({ settings, shifts }: Props) {
 ...
 return (
 <div className="bg-card rounded-[24px] shadow-sm border border-border overflow-hidden flex flex-col h-full">
 <div className="p-5 border-b border-border bg-background flex justify-between items-center">
 <div className="flex items-center gap-2">
 <BrainCircuit className="w-5 h-5 text-indigo-500" />
 <h3 className="font-bold text-foreground">Global Loss Prevention</h3>
 </div>
