...
export default function FundTransferForm() {
 ...
 <label className="block text-sm font-medium text-foreground">Source Account</label>
 <select
 required
 className="w-full p-2 border border-border rounded focus:ring-blue-500 focus:border-blue-500"
 value={sourceId}
 ...
 <div className="space-y-2">
 <label className="block text-sm font-medium text-foreground">Destination Account</label>
 <select
 required
 className="w-full p-2 border border-border rounded focus:ring-blue-500 focus:border-blue-500"
 value={destId}
 ...
 <div className="space-y-2">
 <label className="block text-sm font-medium text-foreground">Transfer Amount (Rs)</label>
 <input
 type="number"
 required
 min="1"
 ...
 className="w-full p-2 border border-border rounded focus:ring-blue-500 focus:border-blue-500 font-mono text-lg"
 value={amount}
 ...
 <div className="space-y-2">
 <label className="block text-sm font-medium text-foreground">Description / Reference</label>
 <input
 type="text"
