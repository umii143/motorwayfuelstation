...
export default function OwnerDrawingsForm() {
 ...
 <label className="block text-sm font-medium text-foreground">Withdraw From</label>
 <select
 required
 className="w-full p-2 border border-border rounded focus:ring-amber-500 focus:border-amber-500"
 value={sourceId}
 ...
 <div className="space-y-2">
 <label className="block text-sm font-medium text-foreground">Withdrawal Amount (Rs)</label>
 <input
 type="number"
 required
 min="1"
 ...
 className="w-full p-2 border border-border rounded focus:ring-amber-500 focus:border-amber-500 font-mono text-lg"
 value={amount}
 ...
 <div className="space-y-2">
 <label className="block text-sm font-medium text-foreground">Description / Reason</label>
 <input
 type="text"
 required
