...
export default function TreasuryDashboard() {
 ...
 <div className="flex justify-between items-center p-4 bg-subtle rounded-lg cursor-pointer hover:bg-gray-100 transition-colors" onClick={() => openLedger('cash_drawer', 'Shift Cash Drawer')}>
 <div className="flex items-center space-x-3">
 <span className="font-medium text-foreground">Shift Drawer (Active)</span>
 </div>
 ...
 <div className="flex justify-between items-center p-4 bg-subtle rounded-lg cursor-pointer hover:bg-gray-100 transition-colors" onClick={() => openLedger('jazzcash', 'JazzCash')}>
 <div className="flex items-center space-x-3">
 <span className="font-medium text-foreground">JazzCash Ledger</span>
 </div>
 <span className="font-bold text-foreground">
 ...
 <div className="flex justify-between items-center p-4 bg-subtle rounded-lg cursor-pointer hover:bg-gray-100 transition-colors" onClick={() => openLedger('easypaisa', 'EasyPaisa')}>
 <div className="flex items-center space-x-3">
 <span className="font-medium text-foreground">EasyPaisa Ledger</span>
 </div>
 <span className="font-bold text-foreground">
 ...
 <div className="flex items-center space-x-3">
 <span className="font-bold text-indigo-900">Total Liquid Assets</span>
 </div>
 ...
 <CardContent>
 <div className="p-6 bg-blue-50 rounded-xl text-blue-800 border border-blue-100">
