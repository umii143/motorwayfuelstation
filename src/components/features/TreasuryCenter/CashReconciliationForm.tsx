...
export default function CashReconciliationForm() {
 ...
 Formula: <code className="bg-muted px-1 rounded">Expected Cash = Opening + Inflows - Outflows</code>
 </CardDescription>
 </CardHeader>
 <CardContent>
 {status && (
 ...
 <label className="block text-sm font-medium text-foreground">Target Cash Account</label>
 <select
 required
 className="w-full p-2 border border-border rounded focus:ring-indigo-500 focus:border-indigo-500"
 value={accountId}
 ...
 <p className="text-sm text-muted-foreground">Expected (System)</p>
 ...
 <p className="text-sm text-blue-600">Physical (Actual)</p>
 <input
 type="number"
 required
 min="0"
 step="0.01"
 placeholder="Count..."
 className="w-full mt-2 bg-transparent text-2xl font-bold font-mono text-blue-900 border-b-2 border-blue-300 focus:outline-none focus:border-blue-600 dark:focus:border-blue-400 placeholder-blue-300/50 dark:placeholder-blue-700/50"
 value={physicalCash}
 ...
 physicalCash === '' ? 'bg-gray-50 dark:bg-card/40 border-gray-200 dark:bg-card dark:border-gray-700' :
 ...
 <div className="space-y-2">
 <label className="block text-sm font-medium text-foreground">Reconciliation Notes</label>
 <input
 type="text"
