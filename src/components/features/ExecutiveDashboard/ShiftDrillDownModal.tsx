...
export default function ShiftDrillDownModal({
 ...
 <div>
 <h2 className="text-xl font-black text-foreground tracking-tight">Enterprise Shift Intelligence</h2>
 <p className="text-sm font-medium text-muted-foreground">Cash Integrity & Staff Performance Analytics</p>
 </div>
 </div>
 <button 
 onClick={onClose}
 ...
 <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest block mb-1">Total Cash Collected</span>
 <h3 className="text-2xl font-black text-foreground">{formatCurrency(kpis.totalCashCollected, settings)}</h3>
 ...
 <div className="premium-card border border-border flex flex-col h-full max-h-[350px]">
 <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-4 flex-none">
 ...
 .map(([name, data]) => (
 <div key={name} className="flex flex-col gap-1.5 pb-3 border-b border-border last:border-0 last:pb-0">
 <div className="flex items-center justify-between">
 <span className="text-sm font-bold text-foreground">{name} <span className="text-xs font-medium text-muted-foreground">({data.shifts} shifts)</span></span>
 ...
 <div className="text-center py-6 text-sm text-muted-foreground font-medium">No staff data available.</div>
 )}
 </div>
 </div>
 ...
 <h3 className="text-sm font-bold text-foreground uppercase tracking-wider">Comprehensive Shift Ledger</h3>
 ...
 className="pl-8 pr-3 py-1.5 border border-border rounded-lg text-xs font-medium focus:outline-none focus:ring-2 focus:ring-amber-500 bg-card w-64"
 />
 </div>
 </div>
 ...
 <td className="p-3">
 <div className="font-bold text-foreground text-xs">{txn.date}</div>
 <div className="text-[10px] font-medium text-muted-foreground">{txn.startTime}</div>
 </td>
 <td className="p-3">
 <div className="font-bold text-foreground text-xs">{staffName}</div>
 </td>
 <td className="p-3 text-right">
 <span className="font-mono text-xs font-bold text-foreground">{formatCurrency(txn.submittedCash || 0, settings)}</span>
 </td>
 <td className="p-3 text-right">
 ...
 <span className="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase bg-muted text-muted-foreground">Closed</span>
 )}
 </td>
 </tr>
 );
