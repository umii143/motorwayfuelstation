...
export default function ProfitDrillDownModal({
 ...
 <div>
 <h2 className="text-xl font-black text-foreground tracking-tight">Enterprise Profit Intelligence</h2>
 <p className="text-sm font-medium text-muted-foreground">Gross Margins, Net Income & Operational Efficiency</p>
 </div>
 </div>
 <button 
 onClick={onClose}
 ...
 <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest block mb-1">Total Gross Profit</span>
 <h3 className="text-2xl font-black text-foreground">{formatCurrency(totalGrossProfit, settings)}</h3>
 ...
 <div className="premium-card border border-border flex flex-col h-full">
 <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-4 flex-none">
 Profit Waterfall
 </h3>
 <div className="flex-1 overflow-y-auto space-y-4">
 <div className="flex items-center justify-between p-3 bg-subtle rounded-lg border border-border">
 <span className="text-sm font-bold text-muted-foreground">Total Revenue</span>
 <span className="text-sm font-black text-foreground">{formatCurrency(kpis.revenue.ytd, settings)}</span>
 </div>
 ...
 <h3 className="text-sm font-bold text-foreground uppercase tracking-wider">Product Margins Ledger</h3>
 </div>
 ...
 <tr>
 <td colSpan={3} className="p-8 text-center text-muted-foreground text-sm font-medium">
 ...
 <td className="p-3 text-right">
 <span className="font-mono text-xs font-bold text-muted-foreground">{percentage.toFixed(2)}%</span>
 </td>
 </tr>
 );
 })
