...
export default function TreasuryDrillDownModal({
 ...
 <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">Total Corporate Liquidity</p>
 ...
 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Physical Cash</p>
 <Wallet className="h-4 w-4 text-muted-foreground" />
 </div>
 <p className="text-xl font-black text-foreground">{formatCurrency(stats.totalCash, settings)}</p>
 </div>
 
 <div className="premium-card p-4 border flex flex-col justify-between">
 <div className="flex justify-between items-start">
 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Bank Balance</p>
 <Building2 className="h-4 w-4 text-muted-foreground" />
 </div>
 <p className="text-xl font-black text-foreground">{formatCurrency(stats.totalBank, settings)}</p>
 </div>
 
 <div className="premium-card p-4 border flex flex-col justify-between">
 <div className="flex justify-between items-start">
 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Digital Wallets</p>
 <Smartphone className="h-4 w-4 text-muted-foreground" />
 </div>
 <p className="text-xl font-black text-foreground">{formatCurrency(stats.totalDigital, settings)}</p>
 </div>
 </div>
 ...
 <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1 block">Filter Source</label>
 <select 
 value={sourceFilter} 
 ...
 <tr key={entry.id + i} className="border-b border-border hover:bg-slate-50 transition-colors">
 ...
 <td className="p-3 align-top">
 <p className="font-bold text-foreground uppercase text-[10px]">{entry.source}</p>
 {entry.destination !== '-' && (
 <p className="text-[10px] text-muted-foreground">→ {entry.destination}</p>
 )}
 </td>
 <td className="p-3 align-top">
 <p className="font-medium text-foreground truncate max-w-full max-w-[200px]">{entry.reference}</p>
 </td>
