...
export default function SupplierLiabilityDrillDownModal({
 ...
 <div className="bg-card rounded-xl p-4 shadow-sm relative overflow-hidden lg:col-span-2 border border-border">
 <div className="absolute -right-4 -top-4 size-16 bg-card/5 rounded-full blur-xl pointer-events-none"></div>
 <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">Total Outstanding Payables</p>
 <p className="text-3xl font-black text-amber-400">
 {formatCurrency(stats.totalPayables, settings)}
 </p>
 </div>
 <div className="premium-card p-4 border">
 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Payments Made (Month)</p>
 <p className="text-xl font-black text-emerald-600">-{formatCurrency(stats.thisMonthPayments, settings)}</p>
 </div>
 <div className="premium-card p-4 border">
 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">New Purchases (Month)</p>
 <p className="text-xl font-black text-rose-600">+{formatCurrency(stats.thisMonthPurchases, settings)}</p>
 </div>
 <div className="premium-card p-4 border">
 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Net Liability Movement</p>
 ...
 <div className="premium-card p-4 border">
 <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Overdue Suppliers</p>
 ...
 <div key={creditor.id} className="p-4 border-b border-border last:border-0 hover:bg-slate-50">
 <div className="flex justify-between items-start mb-2">
 <div>
 <p className="text-sm font-bold text-foreground">{creditor.name}</p>
 <p className="text-[10px] text-muted-foreground truncate max-w-full max-w-[150px]">IBAN: {creditor.accountNo}</p>
 </div>
 ...
 <p className="text-lg font-black text-foreground">{formatCurrency(creditor.balance, settings)}</p>
 </div>
 ))}
 {stats.largestCreditors.length === 0 && (
 <div className="p-8 text-center text-muted-foreground text-sm font-medium">No outstanding payables.</div>
 )}
 </div>
 </div>
 </div>
 ...
 <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1 block">Search Supplier</label>
 <select 
 ...
 <td className="p-3 align-top">
 <p className="font-bold text-foreground">{entry.supplierName}</p>
