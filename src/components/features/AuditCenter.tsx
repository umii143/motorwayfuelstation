...
const AuditCenter: React.FC = () => {
 ...
 className="text-xs bg-muted hover:bg-gray-200 px-2 py-1 rounded border border-border transition-colors"
 >
 Verify Hash
 </button>
 ...
 className="px-6 py-2 bg-muted text-foreground hover:bg-slate-200 rounded-full font-bold text-sm transition-colors border border-border"
 >
 ...
 action: <span className="font-bold text-foreground">{a.action}</span>,
 details: <span className="text-sm text-muted-foreground">{a.details}</span>,
 user: a.user
 }));
 ...
 : 'text-gray-600 hover:bg-gray-50 dark:bg-card/40 border border-transparent'
 }`}
 >
 {tab}
 </button>
 ...
 className="px-3 py-2 border rounded-xl bg-subtle focus:ring-2 focus:ring-red-500 outline-none text-sm text-foreground"
 >
