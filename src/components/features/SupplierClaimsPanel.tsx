...
export default function SupplierClaimsPanel({ batches, suppliers, language }: SupplierClaimsPanelProps) {
  ...
  const { supplierClaims, handleAddSupplierClaim, handleUpdateSupplierClaim } = useInventoryStore();
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="flex gap-3 px-5 pb-5">
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-xl bg-red-600 text-white font-black text-sm hover:bg-red-700 disabled:opacity-50"
            >
      ...
      {activeView === 'list' && (
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          {/* Filters */}
          <div className="px-4 py-3 border-b border-slate-100 flex flex-col sm:flex-row gap-2 sm:items-center">
