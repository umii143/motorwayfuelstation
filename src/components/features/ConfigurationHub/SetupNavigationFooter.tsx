...
export function SetupNavigationFooter({ activeViewId, onNavigate }: SetupNavigationFooterProps) {
 ...
 return (
 <div className="mt-8 flex flex-row items-center justify-between gap-4 border-t border-border pt-6">
 <div>
 {prevStep ? (
 <button
 ...
 className={`flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-bold transition-all${isNextAccessible 
