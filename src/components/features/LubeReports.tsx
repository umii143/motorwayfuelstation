...
export default function LubeReports({
  ...
  return (
    <div className="space-y-6 pb-20 lg:pb-5">
      ...
      {/* KPI CARDS ROW */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-6">
        {[
      ...
      {activeTab === 'financial_summary' && (
        <div className="space-y-6">
          ...
          {/* Summary Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {[
