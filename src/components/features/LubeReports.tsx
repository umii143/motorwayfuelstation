...
export default function LubeReports({
 ...
 <div className="flex flex-col gap-3 sm:flex-row items-center sm:justify-between bg-card rounded-xl p-4 text-foreground font-sans text-xs shadow-xs">
 <div className="flex items-center gap-4">
 <div>
 <span className="text-muted-foreground block text-[9px] uppercase tracking-wider">{t('MATCHED RECORDS', 'کل ریکارڈز')}</span>
 ...
 <span className="text-muted-foreground block text-[9px] uppercase tracking-wider">{t('TOTAL AMOUNT', 'کل مبلغ')}</span>
