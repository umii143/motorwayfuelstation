...
export default function TransitShrinkageTracker({ settings, stationId }: Props) {
 ...
 <div>
 <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">Total Transit Loss (30 Days)</p>
 ...
 <div className="bg-card rounded-xl border border-border p-6 shadow-sm flex items-center justify-between">
 <div>
 <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">Avg. Evaporation Rate</p>
 ...
 <h3 className="font-bold text-foreground">Delivery Shrinkage Matrix</h3>
 </div>
 <button className="flex items-center gap-2 text-sm font-bold text-muted-foreground hover:text-indigo-500 transition-colors">
 ...
 <div className="font-bold text-sm text-foreground">{del.id}</div>
 <div className="text-xs text-muted-foreground">{del.date}</div>
 </td>
 <td className="px-6 py-4">
 <div className="font-bold text-sm text-foreground">{del.supplier}</div>
 <div className="text-xs text-muted-foreground">{del.product}</div>
 </td>
 <td className="px-6 py-4">
 <div className="font-bold text-sm text-foreground">{del.driver}</div>
 <div className="text-xs text-muted-foreground">Temp: {del.temp}</div>
 </td>
 <td className="px-6 py-4 text-center font-mono text-sm">{formatLiters(del.dispatched)}</td>
 <td className="px-6 py-4 text-center font-mono text-sm font-bold text-foreground">{formatLiters(del.decanted)}</td>
 ...
 {isCritical ? (
 <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-600 text-xs font-bold">
 <AlertTriangle className="w-3.5 h-3.5" /> Suspected Theft
 </span>
 ) : (
 <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 text-xs font-bold">
 Normal Evap.
 </span>
 )}
 </td>
