...
export default function LogisticsDashboard({ settings, stationId }: LogisticsDashboardProps) {
 ...
 <span className="text-[10px] font-bold text-muted-foreground uppercase">Incoming Tankers</span>
 <div className="p-1.5 bg-rose-500/10 text-rose-500 rounded-lg">
 <Truck className="h-3.5 w-3.5" />
 </div>
 </div>
 <div className="text-xl font-black font-mono text-foreground">{pendingSchedules.length}</div>
 <div className="text-[10px] text-muted-foreground mt-1 font-medium truncate">Scheduled & in transit</div>
 </div>
 </div>
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-1">
 <span className="text-[10px] font-bold text-muted-foreground uppercase">MTD Received</span>
 <div className="p-1.5 bg-indigo-500/10 text-indigo-500 rounded-lg">
 <ArrowRightLeft className="h-3.5 w-3.5" />
 </div>
 </div>
 <div className="text-xl font-black font-mono text-foreground">{mtdReceivedVolume.toLocaleString()} <span className="text-xs text-muted-foreground font-sans">L</span></div>
 <div className="text-[10px] text-muted-foreground mt-1 font-medium truncate">Fuel decanted this month</div>
 </div>
 </div>
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-1">
 <span className="text-[10px] font-bold text-muted-foreground uppercase">MTD Shortage</span>
 <div className="p-1.5 bg-amber-500/10 text-amber-500 rounded-lg">
 <Scale className="h-3.5 w-3.5" />
 </div>
 </div>
 <div className="text-xl font-black font-mono text-foreground">{mtdShortageVolume.toLocaleString()} <span className="text-xs text-muted-foreground font-sans">L</span></div>
 <div className="text-[10px] text-muted-foreground mt-1 font-medium truncate">Lost in transit/decanting</div>
 </div>
 </div>
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-1">
 <span className="text-[10px] font-bold text-muted-foreground uppercase">Shortage Loss</span>
 <div className="p-1.5 bg-rose-500/10 text-rose-500 rounded-lg">
 ...
 <div className="text-[10px] text-muted-foreground mt-1 font-medium truncate">Financial impact of MTD losses</div>
 </div>
 </div>
 </div>
 ...
 <div>
 <div className="font-bold text-foreground text-xs">PO: {schedule?.poNumber || 'any'}</div>
 <div className="text-[10px] text-muted-foreground mt-0.5">Date: {new Date(del.actualDeliveryDate).toLocaleDateString()}</div>
 </div>
 <div className="text-right">
 <div className="font-mono text-xs font-black text-amber-500">Shortage: {del.shortageQuantity} L</div>
 <div className="text-[10px] text-muted-foreground mt-0.5 font-mono">Value: {settings.currency} {del.shortageAmount}</div>
 </div>
 </div>
 );
 })}
