              ...
              {filteredIncidents.map(inc => {
                return (
                  <tr key={inc.id} className="hover:bg-slate-50 dark:bg-white/5/50 transition">
                    ...
                    <td>
                      <div className="font-medium text-slate-900 dark:text-white">{getTankName(inc.sourceId)}</div>
                    </td>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea value={resolutionNotes} onChange={e => setResolutionNotes(e.target.value)} className="w-full px-3 py-2 border border-slate-200 dark:border-white/10 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" placeholder="E.g., Adjusted calibration settings. CCTV verified no theft." rows={3}></textarea>
                </div>
              </div>
            </div>
