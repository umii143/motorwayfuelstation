...
export default function TankVarianceAnalysis({ settings, stationId }: TankVarianceAnalysisProps) {
 ...
 className="flex items-center gap-2 bg-card text-foreground px-4 py-2 rounded-lg text-sm font-bold hover:bg-slate-800 transition whitespace-nowrap"
 >
 ...
 <td>
 <div className="font-medium text-foreground">{getTankName(inc.sourceId)}</div>
 </td>
 ...
 <input type="date" value={date} onChange={e => setDate(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" />
 </div>
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Tank Source *</label>
 <select value={sourceId} onChange={e => setSourceId(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 bg-card">
 {tanks.map(tank => (
 ...
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Variance Type</label>
 ...
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Severity Level</label>
 {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
 <select value={severity} onChange={e => setSeverity(e.target.value as any)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 bg-card">
 ...
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Expected System Volume (Liters) *</label>
 <input type="number" value={expectedAmount} onChange={e => setExpectedAmount(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" />
 </div>
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Actual Dip Volume (Liters) *</label>
 <input type="number" value={actualAmount} onChange={e => setActualAmount(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" />
 </div>
 </div>
 ...
 { }
 <label className="block text-xs font-bold text-foreground mb-1">Investigation Status</label>
 ...
 <div className="md:col-span-2">
 <label className="block text-xs font-bold text-foreground mb-1">Investigation & Resolution Notes</label>
 <textarea value={resolutionNotes} onChange={e => setResolutionNotes(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" placeholder="E.g., Adjusted calibration settings. CCTV verified no theft." rows={3}></textarea>
 </div>
 </div>
 </div>
