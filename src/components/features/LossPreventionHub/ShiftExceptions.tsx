...
export default function ShiftExceptions({ settings, stationId }: ShiftExceptionsProps) {
 ...
 <td>
 <div className="font-medium text-foreground">{new Date(inc.date).toLocaleDateString()}</div>
 ...
 <td>
 <div className="font-medium text-foreground">{getShiftDetails(inc.sourceId)}</div>
 </td>
 ...
 <h2 className="text-lg font-black font-sans text-foreground flex items-center gap-2">
 ...
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Shift Source *</label>
 ...
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Expected Cash ({settings.currency}) *</label>
 ...
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Actual Cash Handed Over ({settings.currency}) *</label>
 ...
 <div className="md:col-span-2">
 <label className="block text-xs font-bold text-foreground mb-1">Audit Notes & Actions Taken</label>
 <textarea value={resolutionNotes} onChange={e => setResolutionNotes(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" placeholder="E.g., Recovered shortage from pump attendant's salary." rows={3}></textarea>
 </div>
 </div>
 </div>
