    ...
    <AnimatePresence>
      {stage !== 'done' && (
        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-indigo-500/20 to-transparent rounded-full" />
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-indigo-500/30 to-transparent rounded-full" />
              <div className="bg-gradient-to-br from-indigo-500 to-blue-600 p-6 rounded-3xl shadow-2xl relative overflow-hidden border border-white/10">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-t from-cyan-400/40 to-transparent mix-blend-overlay"
                />
              </div>
            </div>
            ...
            >
              Fuel<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Pro</span>
            </motion.h1>
