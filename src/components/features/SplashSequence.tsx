...
export const SplashSequence: React.FC<SplashSequenceProps> = ({ onComplete }) => {
 ...
 className="fixed inset-0 z-[9999] bg-card flex flex-col items-center justify-center overflow-hidden"
 >
 ...
 className="text-muted-foreground mt-3 font-medium tracking-wide text-sm"
 >
 ...
 <div className="w-full h-1.5 bg-card rounded-full overflow-hidden relative shadow-inner backdrop-blur-sm border border-border">
 <motion.div
 initial={{ x: '-100%' }}
 animate={{ x: '200%' }}
 transition={{
 ...
 className="absolute bottom-8 text-[10px] text-muted-foreground font-bold uppercase tracking-[0.3em]"
 >
 Powered by Umar Ali ✨
 </motion.div>
 </motion.div>
