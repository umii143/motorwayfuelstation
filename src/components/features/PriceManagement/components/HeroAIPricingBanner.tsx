...
export const HeroAIPricingBanner: React.FC<HeroAIPricingBannerProps> = ({ isUrdu }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-emerald-950 via-slate-900 to-teal-950 border border-emerald-500/30 rounded-2xl p-4 shadow-xl mb-6 relative overflow-hidden">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 relative z-10">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          <span className="px-2.5 py-1 rounded-lg bg-slate-800/80 text-emerald-400 border border-slate-700 font-semibold flex items-center gap-1">
          ...
          <span className="px-2.5 py-1 rounded-lg bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 font-mono font-bold flex items-center gap-1">
