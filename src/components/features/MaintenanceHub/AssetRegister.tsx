...
export default function AssetRegister({ settings, stationId }: AssetRegisterProps) {
 ...
 <div className="text-[10px] uppercase font-bold text-muted-foreground">{asset.type}</div>
 </td>
 ...
 <span className="text-muted-foreground italic text-xs">No Warranty</span>
 ) : expired ? (
 ...
 { }
 <label className="block text-xs font-bold text-foreground mb-1">Asset Name *</label>
 <input type="text" value={name} onChange={e => setName(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" placeholder="e.g. Dispenser Pump #1" />
 </div>
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Asset Type</label>
 ...
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Serial Number</label>
 <input type="text" value={serialNumber} onChange={e => setSerialNumber(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 font-mono" placeholder="XYZ-987654321" />
 </div>

 <div className="border-t border-border pt-4 md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Installation Date *</label>
 <input type="date" value={installationDate} onChange={e => setInstallationDate(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" />
 </div>
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Warranty Expiry Date</label>
 <input type="date" value={warrantyExpiryDate} onChange={e => setWarrantyExpiryDate(e.target.value)} className="w-full px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-rose-500" />
 </div>
 </div>

 { }
 <div className="md:col-span-2 border-t border-border pt-4">
 <label className="block text-xs font-bold text-foreground mb-1">Operational Status</label>
 ...
 'bg-slate-200 border-slate-500 text-foreground')
