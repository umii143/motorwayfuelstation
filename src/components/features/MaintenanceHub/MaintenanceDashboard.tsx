...
export default function MaintenanceDashboard({ settings, stationId }: MaintenanceDashboardProps) {
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-2">
 <span className="text-xs font-bold text-muted-foreground uppercase">Active Schedules</span>
 <div className="p-2 bg-blue-100 text-blue-600 rounded-lg">
 <CalendarCheck className="h-4 w-4" />
 </div>
 </div>
 <div className="text-2xl font-black font-mono text-foreground">{activeSchedules.length}</div>
 <div className="text-xs text-muted-foreground mt-2 font-medium">Pending or in progress</div>
 </div>
 </div>
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-2">
 <span className="text-xs font-bold text-muted-foreground uppercase">MTD Repair Costs</span>
 ...
 <div className="text-xs text-muted-foreground mt-2 font-medium">Total spent this month</div>
 </div>
 </div>
 ...
 <div className="text-2xl font-black font-mono text-foreground">{assets.length}</div>
 <div className="text-xs text-muted-foreground mt-2 font-medium">Registered hardware</div>
 </div>
 </div>
 </div>
 ...
 <div className="text-xs text-muted-foreground mt-0.5 uppercase">{asset.type}</div>
 </div>
 ...
 <div>
 <div className="font-bold text-foreground text-sm">{asset?.name || 'any Asset'}</div>
 <div className="text-xs text-muted-foreground mt-0.5 line-clamp-1">{record.description}</div>
 </div>
 <div className="text-right">
 <div className="font-mono text-sm font-bold text-foreground">{new Date(record.scheduledDate).toLocaleDateString()}</div>
