                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-end gap-1.5 shrink-0">
                      ...
                      {/* Ledger button */}
                      <button
                        onClick={e => { e.stopPropagation(); openCustomerLedger(cust); }}
                                ...
                                <button
                                  onClick={() => {
                                    showConfirm(
                                      ...
                                      t(
                                        `Delete this ledger entry? This will revert the transaction and update the customer's balance.`,
                                        `کیا آپ واقعی اس انٹری کو حذف کرنا چاہتے ہیں؟ اس سے کسٹمر کا بیلنس بھی تبدیل ہو جائے گا۔`
                                      ),
                                      () => {
                                        if (ent.type === 'debit') {
