...
export default function LocalStorageMigrationWizard() {
 ...
 {/* Status Board */}
 {migrationState === 'idle' && (
 <div className="bg-background/40 border border-border rounded-2xl p-4 divide-y divide-border font-sans text-xs">
 ...
 <div className="flex justify-between pt-2.5 text-foreground font-bold">
 ...
 <p className="font-sans text-xs text-muted-foreground font-bold animate-pulse">
 {progressMsg}
 </p>
 </div>
 )}
 ...
 className="flex-1 py-3 px-4 rounded-xl bg-card hover:bg-slate-700 text-muted-foreground font-sans text-xs font-bold transition-all"
 >
 Discard & Start Fresh
 </button>
 <button
