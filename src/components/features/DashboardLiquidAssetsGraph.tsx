...
export function DashboardLiquidAssetsGraph({ cashOnHand, banks, dueRecovery }: Props) {
 ...
 <div>
 <h3 className="font-bold text-foreground text-lg">Liquid Assets & Receivables</h3>
 <p className="text-sm text-muted-foreground">Distribution of physical and book balances</p>
 </div>
 </div>
