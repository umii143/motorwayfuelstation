...
export default function ExecutiveDashboard({ settings, stationId }: ExecutiveDashboardProps) {
 ...
 <span className="text-muted-foreground font-normal">Based on {shifts.length} recorded shifts</span>
 </div>
 ...
 {/* Tooltip */}
 {val > 0 && (
 <div className="absolute -top-10 opacity-0 group-hover:opacity-100 transition-opacity bg-card text-foreground text-[10px] py-1 px-2 rounded whitespace-nowrap z-10 pointer-events-none font-mono">
 ...
 ></div>
 <div className="text-[9px] font-bold text-muted-foreground mt-2 uppercase">
