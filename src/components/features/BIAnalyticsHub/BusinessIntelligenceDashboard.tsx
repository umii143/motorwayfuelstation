...
export default function BusinessIntelligenceDashboard() {
 ...
 <div className="pb-20">
 <div className="mb-6">
 <h1 className="text-3xl font-black text-foreground tracking-tight">Owner's Financial Command Center</h1>
 <p className="text-muted-foreground font-medium mt-1">Real-time business intelligence, capital tracking, and profitability analytics.</p>
 </div>
 ...
 <h3 className="font-sans text-lg font-bold text-foreground mb-2">Profitability Trend</h3>
 <p className="text-sm text-muted-foreground">More charts coming in the next sprint.</p>
 </div>
 </div>
