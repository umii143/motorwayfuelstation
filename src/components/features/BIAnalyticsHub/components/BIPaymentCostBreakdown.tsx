...
export function BIPaymentCostBreakdown({ metrics }: any) {
 ...
 <h3 className="font-sans text-lg font-bold text-foreground">Payment Analysis — Sales Inflow</h3>
 </div>
 </div>
 ...
 <tfoot className="bg-subtle font-bold border-t border-border">
 <tr>
 ...
 <h3 className="font-sans text-lg font-bold text-foreground">Cost Breakdown</h3>
 </div>
 </div>
 <div className="overflow-x-auto flex-1">
 <table className="premium-table">
 ...
 <tbody>
 {renderCostRow('🛢️ Stock Purchase (COGS)', costs.cogs, 'bg-muted text-slate-700')}
