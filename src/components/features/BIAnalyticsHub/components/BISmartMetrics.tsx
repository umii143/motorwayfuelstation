...
import { Droplets, Receipt, Activity } from 'lucide-react';
...
export function BISmartMetrics({ metrics }: any) {
 ...
 <div className="p-4 border-b border-border bg-rose-50 flex items-center justify-between">
 <div className="flex items-center gap-2">
 <Droplets className="w-5 h-5 text-rose-600" />
 <h3 className="font-sans font-bold text-foreground text-sm">Leakage & Test Liters</h3>
 </div>
 </div>
 <div className="p-5 flex flex-col justify-center flex-1">
 <div className="flex justify-between items-center mb-4">
 <span className="text-sm font-medium text-muted-foreground">Total Test Liters</span>
 <span className="font-black text-xl text-foreground">{smartMetrics.totalTestLiters} L</span>
 </div>
 <div className="w-full bg-muted rounded-full h-1.5 mb-2">
 <div className="bg-rose-500 h-1.5 rounded-full" style={{ width: '45%' }}></div>
 </div>
 <p className="text-xs text-muted-foreground">Check calibration frequency. High test liters impact profitability directly.</p>
 </div>
 </div>
 ...
 <h3 className="font-sans font-bold text-foreground text-sm">Credit Exposure</h3>
 </div>
 </div>
 <div className="p-5 flex flex-col justify-center flex-1">
 <div className="flex justify-between items-center mb-4">
 <span className="text-sm font-medium text-muted-foreground">Unrecovered Credit</span>
 <span className="font-black text-xl text-foreground">{formatCurrency(totalCreditExposure)}</span>
 </div>
 <div className="w-full bg-muted rounded-full h-1.5 mb-2">
 <div className="bg-amber-500 h-1.5 rounded-full" style={{ width: '60%' }}></div>
 </div>
 <p className="text-xs text-muted-foreground">Ensure prompt recovery to prevent working capital strangulation.</p>
 </div>
 </div>

 {/* Stock Intelligence */}
 <div className="premium-card border overflow-hidden flex flex-col">
 <div className="p-4 border-b border-border bg-indigo-50 flex items-center justify-between">
 <div className="flex items-center gap-2">
 <Activity className="w-5 h-5 text-indigo-600" />
 <h3 className="font-sans font-bold text-foreground text-sm">Stock Intelligence</h3>
 </div>
 </div>
 <div className="p-5 flex flex-col justify-center flex-1">
