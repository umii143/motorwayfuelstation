...
export function BIDetailedAnalyticsTable({ filter }: any) {
 ...
 <h3 className="font-sans text-lg font-bold text-foreground">Month-by-Month Financial Table</h3>
 </div>
 </div>
 ...
 <tr>
 <td colSpan={6} className="py-8 text-center text-muted-foreground">No data available.</td>
 </tr>
 ) : (
 ...
 <td className="px-5 text-foreground text-right">{formatCurrency(data.invested)}</td>
