...
export function BIInvestmentChart({ shifts = [], batches = [], expenses = [], filter }: any) {
 ...
 <div className="mb-4">
 <h3 className="font-sans text-lg font-bold text-foreground">Investment vs Revenue (Cumulative)</h3>
 <p className="text-xs text-muted-foreground">Track the breakeven point and total capital deployed over time.</p>
 </div>
