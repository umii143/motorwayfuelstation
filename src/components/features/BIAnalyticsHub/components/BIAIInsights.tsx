...
export function BIAIInsights({ metrics }: any) {
 ...
 {aiReport && (
 <div className="mb-6 p-5 bg-card/10 border border-indigo-500/30 rounded-xl">
 ...
 <div className="prose prose-sm prose-invert max-w-none text-foreground" dangerouslySetInnerHTML={{ 
 ...
 <div key={index} className="bg-card/10 rounded-xl p-4 border border-border hover:bg-card/20 transition-colors cursor-default">
