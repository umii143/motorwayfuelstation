...
export function BIMasterKPIs({ metrics, settings }: BIMasterKPIsProps) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 mb-6">
      ...
      {/* 1. Total Invested */}
      <div className="premium-card border border-slate-200 dark:border-white/10 flex flex-col justify-between">
        ...
        <div>
          ...
          <h3 className="text-xl font-black text-slate-800 dark:text-slate-200 mt-1">{formatCurrency(kpi.totalInvested)}</h3>
      ...
      <div className="premium-card border border-slate-200 dark:border-white/10 flex flex-col justify-between">
        ...
        <div>
          ...
          <h3 className="text-xl font-black text-slate-800 dark:text-slate-200 mt-1">{formatCurrency(kpi.totalRevenue)}</h3>
      ...
      <div className="premium-card border border-slate-200 dark:border-white/10 flex flex-col justify-between">
        ...
        <div>
          ...
          <h3 className="text-xl font-black text-slate-800 dark:text-slate-200 mt-1">{formatCurrency(kpi.netProfit)}</h3>
      ...
      <div className="premium-card border border-slate-200 dark:border-white/10 flex flex-col justify-between">
        ...
        <div>
          ...
          <h3 className="text-xl font-black text-slate-800 dark:text-slate-200 mt-1">{kpi.roi.toFixed(2)}%</h3>
      ...
      <div className="premium-card border border-slate-200 dark:border-white/10 flex flex-col justify-between">
        ...
        <div>
          ...
          <h3 className="text-xl font-black text-slate-800 dark:text-slate-200 mt-1">{formatCurrency(stock.valueSell)}</h3>
      ...
      <div className="premium-card border border-slate-200 dark:border-white/10 flex flex-col justify-between">
        <div className="flex justify-between items-start mb-2">
          <div className="p-2 bg-slate-100 dark:bg-white/10 rounded-lg text-slate-600">
        ...
        <div>
          ...
          <h3 className="text-xl font-black text-slate-800 dark:text-slate-200 mt-1">{formatCurrency(stock.valueCost)}</h3>
