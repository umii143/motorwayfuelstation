...
export default function MarginAnalysis({ settings, stationId }: MarginAnalysisProps) {
 ...
 return (
 <div key={product.id} className="border border-border rounded-xl p-5 bg-subtle">
 <div className="flex justify-between items-start mb-4">
 <div>
 <h4 className="font-black text-lg text-foreground">{product.name}</h4>
 <span className="text-xs text-muted-foreground">{stats.volume.toLocaleString()} L Sold Total</span>
 </div>
 ...
 <span className="font-mono font-bold text-foreground">{settings.currency} {stats.avgSellingPrice.toFixed(2)}</span>
 </div>
 <div className="flex justify-between items-center text-sm">
 <span className="text-muted-foreground">Unit Cost</span>
 <span className="font-mono font-bold text-foreground">{settings.currency} {stats.purchasePrice.toFixed(2)}</span>
 </div>
 <div className="flex justify-between items-center text-sm border-b border-border pb-2">
 <span className="text-muted-foreground">Additional Costs</span>
 <span className="font-mono font-bold text-foreground">{settings.currency} {stats.additionalCosts.toFixed(2)}</span>
 </div>
 <div className="flex justify-between items-center text-sm pt-1">
 <span className="font-bold text-foreground">Effective Margin / L</span>
 ...
 <div className="text-xs text-muted-foreground uppercase font-bold mb-1">Total Effective Profit</div>
