...
export function CCTVIntegration({ settings }: { settings: GlobalSettings }) {
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#151521] flex flex-col p-8 items-center justify-center text-center">
      <Camera className="h-12 w-12 text-slate-200 mb-4" />
      <h3 className="font-sans text-lg font-bold text-slate-800 dark:text-slate-200">CCTV IP Camera Link</h3>
...
export function APIGateway({ settings }: { settings: GlobalSettings }) {
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#151521] flex flex-col p-8 items-center justify-center text-center">
      ...
      <h3 className="font-sans text-lg font-bold text-slate-800 dark:text-slate-200">API Access</h3>
