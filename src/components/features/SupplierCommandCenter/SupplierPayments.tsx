...
export default function SupplierPayments({ suppliers, banks, settings, onClose }: SupplierPaymentsProps) {
 ...
 <button onClick={onClose} className="text-muted-foreground hover:text-slate-650 cursor-pointer font-bold text-xl">&times;</button>
 </div>

 <form onSubmit={handleSubmit} className="space-y-4">
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Select Supplier:', 'سپلائر منتخب کریں:')}</label>
 <select
 required
 ...
 {selectedSupplier && (
 <div className="mt-2 text-xs text-muted-foreground bg-theme-bg p-2 rounded-md border border-theme-main flex justify-between">
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Payment Method:', 'ادائیگی کا طریقہ:')}</label>
 <select
 value={paymentMode}
 onChange={(e) => {
 ...
 <div>
 { }
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('From Account:', 'اکاؤنٹ سے:')}</label>
 <select
 value={accountId}
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Amount to Pay:', 'ادائیگی کی رقم:')}</label>
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Date:', 'تاریخ:')}</label>
 <input
 type="date"
 required
 value={date}
 ...
 <div>
 <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1.5">{t('Reference No:', 'حوالہ نمبر:')}</label>
 <input
 type="text"
 value={reference}
