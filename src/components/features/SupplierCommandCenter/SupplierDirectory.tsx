...
export default function SupplierDirectory({
 ...
 {/* Total Suppliers */}
 <div className="bg-card border border-border rounded-xl p-3 sm:p-5 shadow-lg relative overflow-hidden group">
 ...
 <p className="text-muted-foreground text-[10px] sm:text-xs font-semibold mb-0.5 truncate">Total Suppliers</p>
 ...
 <span className="text-muted-foreground truncate">Active <span className="text-emerald-400 ml-0.5 font-semibold">{activeSuppliersCount}</span></span>
 <span className="text-muted-foreground truncate">Inactive <span className="text-rose-400 ml-0.5 font-semibold">{inactiveSuppliersCount}</span></span>
 </div>
 </div>
 ...
 <div className="min-w-0">
 <p className="text-muted-foreground text-[10px] sm:text-xs font-semibold mb-0.5 truncate">Total Outstanding</p>
 ...
 <span className="text-muted-foreground mb-0.5 truncate">Overdue</span>
 ...
 <div className="min-w-0">
 <p className="text-muted-foreground text-[10px] sm:text-xs font-semibold mb-0.5 truncate text-ellipsis">Purchases (MTD)</p>
 ...
 <span className="text-muted-foreground truncate">This Month</span>
 ...
 <div className="min-w-0">
 <p className="text-muted-foreground text-[10px] sm:text-xs font-semibold mb-0.5 truncate">Avg Credit Days</p>
 ...
 <span className="text-muted-foreground truncate">Util.</span>
 ...
 className="w-full bg-card border border-border text-foreground text-sm rounded-lg pl-10 pr-4 py-2.5 focus:outline-hidden focus:border-slate-600 transition-colors"
 />
 </div>
 ...
 <button className="flex items-center gap-2 bg-card border border-border text-muted-foreground px-4 py-2.5 rounded-lg text-sm hover:bg-slate-800 transition-colors hidden lg:flex">
 ...
 <span className="text-sm font-bold text-muted-foreground">{sup.name.substring(0, 2).toUpperCase()}</span>
 )}
 </div>
 <div>
 <h4 className="text-white font-bold text-sm truncate max-w-[140px]">{t(sup.name, sup.urduName)}</h4>
 <p className="text-muted-foreground text-[11px] mt-0.5">{sup.supplierType || 'Fuel Supplier'}</p>
 </div>
 </div>
 <span className={`px-2 py-0.5 rounded text-[10px] font-bold${isActive ? 'bg-emerald-500/10 text-emerald-500' : 'bg-card text-slate-500'}`}>
 ...
 <div>
 <p className="text-muted-foreground text-[10px] uppercase font-semibold mb-1">Outstanding</p>
 ...
 <p className="text-muted-foreground text-[10px] uppercase font-semibold mb-1">Last Purchase</p>
 ...
 <button className="flex flex-col items-center gap-1.5 text-muted-foreground hover:text-white transition-colors">
