...
export function SupplierDetailsPanel({ supplier, settings, shifts, onClose }: SupplierDetailsPanelProps) {
 ...
 className="fixed inset-y-0 right-0 z-50 w-full max-w-xl bg-card border-l border-border shadow-2xl overflow-y-auto flex flex-col"
 >
 {/* Header Section */}
 <div className="p-6 border-b border-border">
 <div className="flex justify-between items-start mb-6">
 <div className="flex items-center gap-4">
 <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-700 flex items-center justify-center border border-border shadow-inner">
 ...
 <p className="text-sm text-muted-foreground font-medium">{typeLabel}</p>
 </div>
 </div>
 <button 
 onClick={onClose}
 className="p-2 bg-card hover:bg-slate-700 text-muted-foreground hover:text-white rounded-lg transition-colors cursor-pointer"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div>
 <p className="text-xs text-muted-foreground mb-0.5">NTN</p>
 ...
 <div>
 <p className="text-xs text-muted-foreground mb-0.5">Average Credit Days</p>
 ...
 <div>
 <p className="text-xs text-muted-foreground mb-0.5">Supplier Since</p>
 ...
 <button className="flex flex-col items-center justify-center gap-2 p-3 bg-card hover:bg-slate-700 rounded-xl border border-border transition-colors cursor-pointer group">
 ...
 <span className="text-xs text-muted-foreground font-medium text-center">Record Payment</span>
 </button>
 <button className="flex flex-col items-center justify-center gap-2 p-3 bg-card hover:bg-slate-700 rounded-xl border border-border transition-colors cursor-pointer group">
 ...
 <span className="text-xs text-muted-foreground font-medium text-center">Create Purchase</span>
 </button>
 <button className="flex flex-col items-center justify-center gap-2 p-3 bg-card hover:bg-slate-700 rounded-xl border border-border transition-colors cursor-pointer group">
 ...
 <span className="text-xs text-muted-foreground font-medium text-center">View Ledger</span>
 </button>
 <button className="flex flex-col items-center justify-center gap-2 p-3 bg-card hover:bg-slate-700 rounded-xl border border-border transition-colors cursor-pointer group">
 ...
 <span className="text-xs text-muted-foreground font-medium text-center">Statement</span>
 </button>
 </div>
 </div>
