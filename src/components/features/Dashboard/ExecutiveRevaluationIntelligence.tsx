...
export default function ExecutiveRevaluationIntelligence({
 ...
 className="bg-card rounded-2xl p-5 shadow-lg relative overflow-hidden text-foreground cursor-pointer hover:ring-2 hover:ring-emerald-500 transition-all group"
 >
 <div className="absolute -right-6 -top-6 size-24 bg-card/5 rounded-full blur-xl pointer-events-none group-hover:bg-card/10 transition-colors"></div>
 ...
 <div className="flex items-center gap-4 mt-4 text-xs font-medium border-t border-border pt-3">
