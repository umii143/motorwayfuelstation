...
export default function FuelProJarvis() {
 ...
 return (
 <div className="w-full h-[calc(100vh-80px)] md:h-full bg-background rounded-[32px] overflow-hidden flex flex-col relative animate-in fade-in zoom-in-95 duration-500">
 
 {/* HEADER */}
 <div className="p-6 border-b border-border bg-card flex justify-between items-center z-10 shadow-sm relative">
 ...
 {isSpeaking && (
 <span className="absolute -top-1 -right-1 w-4 h-4 bg-emerald-500 border-2 border-border rounded-full animate-bounce" />
 )}
 </div>
 <div>
 ...
 <p className="text-sm font-bold text-muted-foreground">Enterprise AI Voice Assistant</p>
 </div>
 </div>
 </div>
 ...
 {/* DYNAMIC MAIN AREA */}
 {isCallModeActive ? (
 <div className="flex-1 flex flex-col items-center justify-center relative overflow-hidden bg-card z-10">
 ...
 {/* Core Orb */}
 <div className={`w-48 h-48 rounded-full flex items-center justify-center backdrop-blur-md border border-border shadow-2xl transition-all duration-500${
 ...
 <p className="text-muted-foreground italic max-w-md mx-auto text-center px-6 text-lg font-medium">"{transcript}"</p>
 )}
 </div>
 </div>
 ) : (
 ...
 <div className="bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 px-4 py-2 rounded-full text-xs font-bold flex items-center gap-2">
 ...
 : 'bg-card text-foreground rounded-bl-sm shadow-sm border border-border dark:border-white/5'
 }`}>
 ...
 <div className="bg-card p-4 rounded-2xl rounded-bl-sm shadow-sm border border-border flex gap-2 items-center">
 ...
 <div className="absolute inset-0 bg-card backdrop-blur-sm z-20 flex flex-col items-center justify-center animate-in fade-in">
 <div className="relative">
 ...
 className="mt-12 px-8 py-3 bg-card text-foreground rounded-full font-black shadow-xl hover:scale-105 transition-transform"
 >
 Done Speaking
 </button>
 </div>
 ...
 : 'bg-muted hover:bg-slate-200 dark:hover:bg-card text-foreground'
 }`}
 >
 ...
 <p className="text-center text-xs font-bold text-muted-foreground mt-4 uppercase tracking-widest">Powered by Gemini 2.5 Flash</p>
 </div>
 </div>
 );
}
