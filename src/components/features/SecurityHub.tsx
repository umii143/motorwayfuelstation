...
export default function SecurityHub({ settings, user, onLogout }: SecurityHubProps) {
 ...
 <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-card text-foreground shadow-lg">
 ...
 <div>
 <h3 className="font-bold text-foreground">{t('Two-Factor Authentication (2FA)', 'دوہری تصدیق (2FA)')}</h3>
 <p className="text-xs text-muted-foreground">{t('Add an extra layer of security', 'سیکیورٹی کی اضافی تہہ شامل کریں')}</p>
 </div>
 </div>
 ...
 <div>
 <h3 className="font-bold text-foreground">{t('Account Security', 'اکاؤنٹ سیکیورٹی')}</h3>
 <p className="text-xs text-muted-foreground">{t('Your current security posture', 'آپ کی موجودہ سیکیورٹی کی حالت')}</p>
 </div>
 </div>
 ...
 <span className="text-sm font-medium text-foreground">{t('Password', 'پاس ورڈ')}</span>
 </div>
 ...
 <span className="text-sm font-medium text-foreground">{t('Role & Permissions', 'کردار اور اجازت نامے')}</span>
 </div>
 <span className="text-xs font-bold px-2 py-1 bg-muted text-foreground rounded-md uppercase">
 {user?.role || 'Admin'}
 </span>
 </div>
 ...
 <span className="text-sm font-medium text-foreground">{t('Organization ID', 'تنظیم کا آئی ڈی')}</span>
 </div>
 <span className="text-xs font-mono text-muted-foreground truncate max-w-full max-w-[120px]">
 {organization.orgId}
 </span>
 </div>
 )}
 ...
 <div className="p-6 border-b border-border flex flex-row items-center justify-between gap-4">
 <div>
 <h3 className="text-lg font-bold text-foreground">{t('Active Device Sessions', 'فعال ڈیوائس سیشنز')}</h3>
 ...
 <div className="p-0">
 {session ? (
 <div className="flex items-start gap-4 p-6 border-b border-border bg-subtle">
 <div className="p-3 bg-emerald-100 text-emerald-600 rounded-xl shrink-0">
 <MonitorSmartphone className="h-6 w-6" />
 </div>
 <div className="flex-1">
 <div className="flex items-center gap-2">
 <h4 className="font-bold text-foreground">{session.browser || 'Current Browser'}</h4>
 ...
 <p className="text-xs text-muted-foreground mt-1 line-clamp-1">{session.deviceName || navigator.userAgent}</p>
 ...
 <div>
 <h3 className="text-lg font-bold text-foreground">{t('Security Audit Logs', 'سیکیورٹی آڈٹ لاگز')}</h3>
 <p className="text-sm text-muted-foreground">
 ...
 <div className="mt-1 p-2 bg-muted text-muted-foreground rounded-lg shrink-0">
 ...
 <History className="h-12 w-12 mb-3 text-muted-foreground" />
