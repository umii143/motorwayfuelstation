...
export function DashboardWeeklyGraph({ data }: Props) {
 ...
 <div>
 <h3 className="font-bold text-foreground text-lg">Weekly Sales & Profit Intelligence</h3>
 <p className="text-sm text-muted-foreground">Showing visual records matching 7 days activities</p>
 </div>
 </div>
