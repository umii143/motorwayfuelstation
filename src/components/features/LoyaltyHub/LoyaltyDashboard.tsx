...
export default function LoyaltyDashboard({ settings, stationId }: LoyaltyDashboardProps) {
 ...
 <div className="text-2xl font-black font-mono text-foreground">{activeMembers.length}</div>
 <div className="text-xs text-muted-foreground mt-2 font-medium">Enrolled customers</div>
 </div>
 </div>
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-2">
 <span className="text-xs font-bold text-muted-foreground uppercase">Total Points Liability</span>
 <div className="p-2 bg-amber-100 text-amber-600 rounded-lg">
 <Coins className="h-4 w-4" />
 </div>
 </div>
 <div className="text-2xl font-black font-mono text-amber-600">{totalPointsLiability.toLocaleString()}</div>
 <div className="text-xs text-muted-foreground mt-2 font-medium">Unredeemed points</div>
 </div>
 </div>
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-2">
 <span className="text-xs font-bold text-muted-foreground uppercase">MTD Points Issued</span>
 <div className="p-2 bg-emerald-100 text-emerald-600 rounded-lg">
 <TrendingUp className="h-4 w-4" />
 </div>
 </div>
 <div className="text-2xl font-black font-mono text-emerald-600">{mtdPointsIssued.toLocaleString()}</div>
 <div className="text-xs text-muted-foreground mt-2 font-medium">Points given this month</div>
 </div>
 </div>
 ...
 <div className="relative">
 <div className="flex justify-between items-start mb-2">
 <span className="text-xs font-bold text-muted-foreground uppercase">MTD Points Redeemed</span>
 <div className="p-2 bg-rose-100 text-rose-600 rounded-lg">
 <Gift className="h-4 w-4" />
 </div>
 </div>
 <div className="text-2xl font-black font-mono text-rose-600">{mtdPointsRedeemed.toLocaleString()}</div>
 <div className="text-xs text-muted-foreground mt-2 font-medium">Points spent this month</div>
 </div>
 </div>
 </div>
 ...
 <div className="font-mono text-sm font-bold text-foreground">{member.pointsBalance.toLocaleString()} pts</div>
 <div className="mt-1">
 ...
 <div>
 <div className="font-bold text-foreground text-sm">{member?.name || 'any Member'}</div>
