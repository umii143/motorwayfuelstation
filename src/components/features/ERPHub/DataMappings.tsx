...
export default function DataMappings({ settings, stationId }: DataMappingsProps) {
 ...
 <div className="px-6 py-4 border-b border-border bg-subtle flex justify-between items-center">
 <div>
 <h3 className="font-bold text-foreground flex items-center gap-2">
 <Database className="h-4 w-4 text-muted-foreground" />
 Master Data Mappings
 </h3>
 <p className="text-xs text-muted-foreground mt-1">Map local FuelPro entities to your ERP's master data identifiers.</p>
 </div>
 </div>

 <div className="p-6">
 <div className="grid grid-cols-12 gap-4 mb-4 text-xs font-bold text-muted-foreground uppercase tracking-wider border-b border-border pb-2">
 ...
 <div className="bg-subtle border border-border px-3 py-2 rounded text-sm text-foreground font-medium truncate">
 {map.local}
 </div>
 </div>
 <div className="col-span-2 flex justify-center">
 <ArrowRight className="h-4 w-4 text-muted-foreground group-hover:text-rose-400 transition" />
 </div>
 <div className="col-span-4">
 <input 
 type="text" 
 defaultValue={map.external}
 className="w-full bg-card border border-border px-3 py-2.5 sm:py-2 min-h-[48px] sm:min-h-[40px] rounded text-sm font-mono text-foreground focus:ring-2 focus:ring-rose-500 outline-none"
 />
 </div>
