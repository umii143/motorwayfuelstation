...
export default function CredentialsManager({ settings, stationId }: CredentialsManagerProps) {
 ...
 <button className="flex items-center gap-1 bg-card text-foreground px-3 py-1.5 rounded text-xs font-bold hover:bg-slate-800 transition">
 ...
 <button className="p-1.5 text-muted-foreground hover:text-slate-600 hover:bg-slate-200 rounded transition" title="Reveal">
 <Eye className="h-3 w-3" />
 </button>
 <button className="p-1.5 text-muted-foreground hover:text-slate-600 hover:bg-slate-200 rounded transition" title="Copy">
 ...
 <div className="premium-card border overflow-hidden">
 <div className="px-6 py-4 border-b border-border bg-subtle">
 <h3 className="font-bold text-foreground">Outgoing Webhooks</h3>
 <p className="text-xs text-muted-foreground mt-1">Configure endpoints to receive real-time events when data changes.</p>
 </div>
 <div className="p-6 space-y-4">
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Endpoint URL</label>
 <input type="url" placeholder="https://api.yourcompany.com/webhooks/fuel" className="w-full px-3 py-2.5 sm:py-2 min-h-[48px] sm:min-h-[40px] border border-border rounded-lg text-sm focus:ring-2 focus:ring-rose-500" />
 </div>
 <div>
 <label className="block text-xs font-bold text-foreground mb-1">Event Types</label>
 <select className="w-full px-3 py-2.5 sm:py-2 min-h-[48px] sm:min-h-[40px] border border-border rounded-lg text-sm focus:ring-2 focus:ring-rose-500 bg-card">
