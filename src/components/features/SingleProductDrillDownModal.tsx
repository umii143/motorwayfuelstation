...
export default function SingleProductDrillDownModal({
 ...
 className="relative w-full max-w-4xl max-h-[90vh] bg-subtle rounded-2xl shadow-2xl overflow-hidden flex flex-col"
 >
 {/* HEADER */}
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 bg-muted hover:bg-slate-200 text-foreground font-bold rounded-lg transition-colors text-xs border border-border"
 >
 ...
 <h3 className="text-2xl font-black text-foreground">{metrics.currentStock.toLocaleString()} <span className="text-sm font-medium text-muted-foreground">{product.unit}</span></h3>
 ...
 <h3 className="text-2xl font-black text-foreground">{formatCurrency(metrics.totalStockValue, settings)}</h3>
 <div className="mt-2 flex items-center justify-between text-xs font-bold text-muted-foreground border-t pt-2">
 ...
 <div className="premium-card border border-border bg-card text-foreground">
 <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest block mb-1">
 ...
 <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">{t('Last Purchased From', 'آخری سپلائر')}</div>
 <div className="font-bold text-foreground">{metrics.lastSupplierName}</div>
 ...
 <div className="flex-1">
 <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">{t('Last Sale Record', 'آخری فروخت')}</div>
 ...
 <div className="h-40 flex items-end justify-between gap-2 px-2 pb-6 pt-4 border-b border-border relative">
 {/* Y-axis placeholder line */}
 <div className="absolute left-0 bottom-6 w-full border-t border-dashed border-border"></div>
 ...
 {/* Tooltip */}
 <div className="absolute -top-8 bg-card text-foreground text-[10px] py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity z-10 whitespace-nowrap pointer-events-none">
 ...
 {/* Label */}
 <div className="absolute -bottom-6 text-[9px] font-bold text-muted-foreground truncate w-full text-center">
 {isReceipt ? 'IN' : 'OUT'}
 </div>
 </div>
 )
