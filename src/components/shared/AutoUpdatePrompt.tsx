...
export function AutoUpdatePrompt() {
 ...
 <AnimatePresence>
 {isVisible && (
 <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-card backdrop-blur-sm">
 <motion.div
 ...
 <div className="absolute -right-4 -top-4 w-24 h-24 bg-card/10 rounded-full blur-2xl" />
 
 <div className="relative z-10 w-16 h-16 bg-card rounded-full shadow-lg flex items-center justify-center">
 ...
 className="w-full text-sm font-bold text-muted-foreground hover:text-slate-700 py-2 transition-colors"
 >
 Remind Me Later
 </button>
 </div>
