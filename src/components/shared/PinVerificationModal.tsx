...
export const PinVerificationModal: React.FC<PinVerificationModalProps> = ({
 ...
 >
 <div className="absolute inset-0 bg-card backdrop-blur-md" onClick={onClose} />
 ...
 className="relative bg-card border border-border/50 /50 rounded-[2.5rem] p-8 w-full max-w-sm shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden"
 >
 {/* Background glow */}
 ...
 <button
 onClick={onClose}
 className="absolute right-6 top-6 w-8 h-8 flex items-center justify-center rounded-full bg-muted text-muted-foreground hover:text-slate-700 dark:hover:text-slate-300 transition-colors z-10"
 >
 <X className="w-4 h-4" />
 </button>
 ...
 className="w-16 h-16 rounded-full bg-subtle hover:bg-muted/50 dark:hover:bg-slate-800 flex items-center justify-center text-2xl font-medium text-foreground mx-auto transition-colors shadow-sm"
 >
 {num}
 </motion.button>
 ))}
 ...
 className="w-16 h-16 rounded-full flex items-center justify-center text-muted-foreground hover:text-slate-600 dark:hover:text-slate-300 mx-auto transition-colors"
 >
