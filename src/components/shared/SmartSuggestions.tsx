...
export const SmartSuggestions: React.FC<SmartSuggestionsProps> = ({ onClose }) => {
 ...
 className="text-indigo-200 hover:text-white transition-colors p-1 rounded-full hover:bg-card/20"
 >
 <X className="w-4 h-4" />
 </button>
 </div>
 ...
 <div className="bg-subtle px-4 py-3 border-t border-border flex justify-center">
