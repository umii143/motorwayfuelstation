...
export function NotificationCenter() {
 ...
 className="relative p-2 rounded-full hover:bg-muted transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
 ...
 <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-red-500 border border-border"></span>
 </span>
 )}
 </button>
 ...
 className="absolute right-0 mt-2 w-80 sm:w-96 rounded-xl bg-card/90 backdrop-blur-xl shadow-2xl border border-border z-50 overflow-hidden"
 >
 ...
 <p className={`text-sm font-semibold truncate pr-2${notification.read ? 'text-slate-600' : 'text-foreground'}`}>
 {notification.title}
 </p>
 <span className="text-[10px] text-muted-foreground whitespace-nowrap flex items-center gap-1 mt-0.5">
 ...
 <button className="text-xs font-bold text-muted-foreground hover:text-indigo-600 transition-colors cursor-pointer">
 View All Activity
 </button>
 </div>
 </motion.div>
