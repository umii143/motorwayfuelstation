...
export const WhatsAppShareModal: React.FC<WhatsAppShareModalProps> = ({
 ...
 className="w-full max-w-2xl bg-card rounded-xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
 >
 {/* Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card">
 <div className="flex items-center gap-3">
 <div className="p-2 bg-card text-foreground rounded-full">
 <MessageSquare className="w-5 h-5" />
 </div>
 <div>
 <h2 className="text-lg font-bold text-foreground">Share via WhatsApp</h2>
 <p className="text-xs text-muted-foreground font-medium">Instantly send documents & reports</p>
 </div>
 </div>
 <button
 onClick={closeShareModal}
 className="p-2 text-muted-foreground hover:bg-muted hover:text-slate-600 rounded-full transition-colors"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 />
 <span className="text-sm font-medium text-foreground">Text Summary Only</span>
 </label>
 <label className={`flex items-center gap-3 p-3 border border-border rounded-lg cursor-pointer hover:bg-slate-50 transition-colors${!(shareState.pdfBlob || shareState.pdfDocument) ? 'opacity-50 pointer-events-none' : ''}`}>
 <input 
 type="radio" 
 name="format" 
 checked={format === 'both'} 
 ...
 className="accent-green-500 w-4 h-4"
 />
 <span className="text-sm font-medium text-foreground">Text + PDF Attachment</span>
 </label>
 </div>
 </div>
 ...
 />
 <span className="text-sm font-medium text-foreground">Open in WhatsApp Business</span>
 </label>
 </div>
 ...
 <div className="bg-card rounded-xl p-4 h-full min-h-[300px] border border-border relative shadow-inner">
 {/* Mock WhatsApp Message Bubble */}
 <div className="bg-card rounded-lg p-3 text-sm text-foreground shadow-xs relative max-w-[90%] whitespace-pre-wrap font-sans leading-relaxed">
 {previewMessage}
 <div className="text-[10px] text-muted-foreground text-right mt-1.5 font-medium">
 ...
 {/* Footer Actions */}
 <div className="border-t border-border bg-subtle p-4 flex justify-end gap-3 rounded-b-xl">
 <button
 onClick={closeShareModal}
 className="px-5 py-2.5 text-sm font-bold text-muted-foreground bg-card border border-border rounded-lg hover:bg-slate-50 transition-colors"
 >
 Cancel
 </button>
 <button
 ...
 className="px-5 py-2.5 text-sm font-bold text-foreground bg-card rounded-lg hover:bg-[#1DA851] transition-colors flex items-center gap-2 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
 >
