...
export default function IdleScreenLock() {
 ...
 className="fixed inset-0 z-[9999] bg-card backdrop-blur-xl flex flex-col items-center justify-center p-4"
 >
 {/* Top Brand Banner */}
 ...
 className="w-full max-w-sm bg-card/10 backdrop-blur-md border border-border rounded-3xl p-6 md:p-8 shadow-2xl flex flex-col items-center"
 >
 <div className="flex items-center justify-center h-12 w-12 rounded-full bg-card border border-border mb-4">
 ...
 : 'bg-card/50 border border-slate-600/50'
 }`}
 />
 ))}
 </div>
 ...
 lockoutTime !== null 
 ? 'bg-card/30 text-slate-500 cursor-not-allowed'
 : key === 'C' 
 ? 'bg-rose-500/10 text-rose-400 hover:bg-rose-500/20 hover:text-rose-300 border border-rose-500/20' 
 : key === '<'
 ? 'bg-card/40 text-slate-300 hover:bg-slate-600/60 border border-slate-600/30'
 : 'bg-card/5 text-white hover:bg-card/15 border border-white/10 hover:border-white/20 active:scale-95'
 }`}
 >
 {key}
 </button>
