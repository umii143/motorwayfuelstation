...
export const PoweredByUmarAli: React.FC<PoweredByUmarAliProps> = ({ 
 ...
 <div className="flex items-center gap-1.5 text-sm tracking-wide bg-subtle border border-border px-4 py-1.5 rounded-full shadow-xs backdrop-blur-sm">
 <span className="font-medium text-[var(--text-muted,inherit)]">Powered by</span>
 <DeveloperTag />
 </div>
 <div className="flex flex-col sm:flex-row items-center gap-3">
 <p className="text-xs font-bold bg-subtle text-[var(--text-muted,inherit)] px-3 py-1 rounded-full border border-border">Motorway Petroleum, Mardan KPK</p>
 <ContactTag />
 </div>
 ...
 if (variant === 'receipt') {
 return (
 <div className={`font-mono text-center text-[10px] sm:text-xs mt-6 pt-3 border-t-2 border-dashed border-border${className}`}>
 <div className="font-bold flex flex-col sm:flex-row items-center justify-center gap-x-2 gap-y-1 mb-1">
 <span className="flex items-center gap-1 text-foreground">
 Powered by Umar Ali <Zap className="w-3 h-3 text-foreground fill-slate-800" />
 </span>
 ...
 <div className="text-[9px] sm:text-[10px] text-muted-foreground font-bold uppercase tracking-widest mt-1 border border-border inline-block px-2 py-0.5 rounded-md">FuelPro FSMS v2.0</div>
 </div>
 );
 }
 ...
 <div className="text-xs sm:text-sm font-semibold text-foreground flex items-center gap-1.5 uppercase tracking-widest bg-card/80 backdrop-blur-md px-4 py-1.5 rounded-full shadow-lg border border-border">
 Powered by <DeveloperTag />
 </div>
 <div className="bg-card/90 backdrop-blur-md px-1 py-1 rounded-lg shadow-lg border border-emerald-100/50">
 <ContactTag />
 </div>
 </div>
 </div>
 ...
 <div className="transform -rotate-45 text-4xl md:text-5xl font-black whitespace-nowrap mt-4 text-foreground">
 WA: 0316-8432329
 </div>
 </div>
 );
 ...
 return (
 <div className={`w-full bg-card border border-border rounded-2xl md:rounded-3xl p-4 md:p-6 relative overflow-hidden flex flex-col md:flex-row items-center md:items-stretch gap-4 md:gap-6 shadow-2xl${className}`}>
 
 {/* Version Badge */}
 <div className="absolute top-4 right-4 bg-card/5 px-2.5 py-1 rounded-lg border border-border">
 ...
 <span className="text-[9px] md:text-[10px] font-semibold text-muted-foreground uppercase tracking-widest mb-0.5">Powered By</span>
 ...
 target="_blank" 
 rel="noopener noreferrer"
 className="flex items-center gap-2 bg-card border border-[#233524] px-3 py-1.5 md:px-4 md:py-2 rounded-xl transition-all hover:bg-[#1E2B22]"
 >
 ...
 {/* Divider */}
 <div className="hidden md:block w-px bg-card/5 my-2 mx-2"></div>
 <div className="block md:hidden h-px w-3/4 mx-auto bg-card/5 my-0.5"></div>
 ...
 <span className="hidden md:block text-muted-foreground text-[9px] md:text-[10px] leading-tight max-w-[120px]">Your data is always protected</span>
 </div>
 </div>
 ...
 <span className="hidden md:block text-muted-foreground text-[9px] md:text-[10px] leading-tight max-w-[120px]">Real-time backup and sync</span>
 </div>
 </div>
 ...
 <span className="hidden md:block text-muted-foreground text-[9px] md:text-[10px] leading-tight max-w-[120px]">We are always here to help</span>
 </div>
 </div>
 </div>
 ...
 return (
 <div className={`w-full flex flex-col gap-2 p-3 rounded-xl bg-gradient-to-b from-white/5 to-white/0 border border-border backdrop-blur-sm relative overflow-hidden group${className}`}>
 {/* Subtle shine effect */}
 ...
 <span className="text-[9px] font-bold text-white/30 bg-card/5 px-1.5 py-0.5 rounded backdrop-blur-md border border-border">v2.0</span>
 </div>
