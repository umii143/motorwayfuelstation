...
export function GlobalSearchModal({
 ...
 {/* Modal */}
 <div className="relative w-full max-w-2xl mx-4 bg-surface-container-high border border-outline-variant rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]">
 {/* Search Input */}
 ...
 className="flex-1 bg-transparent text-on-surface placeholder:text-on-surface-variant text-base focus:outline-none"
 />
 ...
 <kbd className="px-2 py-0.5 text-xs rounded bg-surface-container text-on-surface-variant border border-outline-variant">
 Esc
 </kbd>
 </div>
 ...
 <div>
 <p className="px-4 pt-3 pb-1 text-xs font-semibold text-on-surface-variant uppercase tracking-wide">
 Recent
 </p>
 ...
 {action.shortcut && (
 <kbd className="text-xs px-1.5 py-0.5 rounded bg-surface-container text-on-surface-variant border border-outline-variant">
 {action.shortcut}
 </kbd>
 )}
 </button>
 ...
 {/* Footer */}
 <div className="px-4 py-2.5 border-t border-outline-variant flex items-center justify-between mt-auto">
