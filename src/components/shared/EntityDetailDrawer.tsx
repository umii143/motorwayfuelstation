...
export default function EntityDetailDrawer({ entity, onClose, onNavigateModule, onReanchor }: EntityDetailDrawerProps) {
 ...
 <div className="absolute inset-0 bg-card backdrop-blur-sm animate-fade-in" onClick={onClose} />  <div className="relative w-full max-w-md h-dvh flex flex-col bg-card border-l border-border shadow-2xl animate-slide-in">
 {/* Header */}
