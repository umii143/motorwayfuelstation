...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
 ...
 secondary: 'bg-muted text-foreground hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl',
 outline: 'border-2 border-border text-slate-700 hover:border-border hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-xl',
 ghost: 'bg-transparent text-slate-600 hover:bg-slate-100 dark:hover:bg-card/5 rounded-xl',
