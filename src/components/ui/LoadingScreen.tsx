...
export default function LoadingScreen({ message = 'Loading System...' }: LoadingScreenProps) {
 ...
 return (
 <div className="fixed inset-0 z-[20000] min-h-screen w-full flex flex-col justify-center items-center overflow-hidden bg-card font-sans">
 ...
 <div className="relative z-10 p-4 rounded-full border-2 border-orange-500 bg-card backdrop-blur-md shadow-[0_0_50px_rgba(255,100,0,0.6)] flex items-center justify-center">
 ...
 <div className="relative h-1.5 w-full bg-card rounded-full overflow-hidden border border-border shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
 <motion.div 
 ...
 <div className={`w-1.5 h-1.5 rounded-full transition-all duration-75${progress >= step ? 'bg-orange-400 shadow-[0_0_10px_rgba(255,160,0,1)] scale-[1.5]' : 'bg-card'}`} />
 </div>
 ))}
 </div>
 </div>
