...
export class CrashCenter extends Component<Props, State> {
 ...
 return (
 <div className="min-h-[400px] h-full w-full flex items-center justify-center bg-subtle p-6 rounded-2xl border border-rose-100 shadow-sm animate-in fade-in duration-300">
 <div className="max-w-xl w-full bg-card rounded-xl shadow-lg border border-border overflow-hidden">
 ...
 <div className="bg-card rounded-lg p-4 overflow-x-auto max-h-[200px] overflow-y-auto">
 <div className="flex items-center gap-2 mb-2 text-muted-foreground border-b border-border pb-2">
 ...
 className="px-4 py-2 text-sm font-bold text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors cursor-pointer"
 >
 Dismiss & Reset
 </button>
 <button
