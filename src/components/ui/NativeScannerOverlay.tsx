 ...
 */}
 ...
 {/* Top Bar */}
 <div className="relative z-10 flex items-center justify-between p-4 bg-card backdrop-blur-md pt-safe">
 ...
 <button 
 onClick={toggleTorch}
 className={`p-3 rounded-full transition-colors${torchOn ? 'bg-yellow-400 text-foreground' : 'bg-card/10 text-white hover:bg-card/20'}`}
 >
 ...
 {/* Targeting Reticle */}
 <div className="relative w-full h-full max-w-[300px] max-h-[300px] border-2 border-border rounded-xl shadow-[0_0_0_9999px_rgba(0,0,0,0.6)]">
 {/* Corner brackets */}
