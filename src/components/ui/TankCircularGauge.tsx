...
export const TankCircularGauge: React.FC<TankCircularGaugeProps> = ({
 ...
 return (
 <div className="bg-card rounded-[24px] p-5 shadow-sm border border-border flex flex-col items-center justify-between h-full">
 ...
 <div className="w-full py-2 rounded-xl border border-border text-center">
