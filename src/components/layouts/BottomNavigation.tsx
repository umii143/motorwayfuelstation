...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({ activeView, onNavigate, onMenuClick }) => {
  return (
    <>
      <div className="flex-none w-full h-[60px] bg-white dark:bg-[#151521] border-t border-slate-200 dark:border-white/5 flex items-center justify-around px-1 lg:hidden">
        ...
        <div className="relative w-14 h-full flex justify-center">
          <button 
            ...
            className={`absolute -top-4 w-12 h-12 rounded-full flex items-center justify-center text-white shadow-lg border-4 border-white dark:border-[#151521] transition-transform active:scale-95 ${
              activeView === 'jarvis' 
