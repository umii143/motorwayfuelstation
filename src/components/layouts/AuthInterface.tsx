...
export default function AuthInterface({ settings, onLoginSuccess }: AuthInterfaceProps) {
  ...
  return (
    <div className="h-[100dvh] w-full bg-[#0a0e17] text-white flex flex-col font-sans selection:bg-orange-500/30 overflow-y-auto overflow-x-hidden scroll-smooth relative">
