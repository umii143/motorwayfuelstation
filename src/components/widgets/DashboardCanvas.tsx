...
export function DashboardCanvas() {
 ...
 <Activity className="w-8 h-8 text-muted-foreground animate-pulse mb-4" />
 <div className="text-sm font-bold text-muted-foreground">Loading Dashboard Layout...</div>
 </div>
 );
 }
 ...
 return (
 <div className="w-full h-full flex flex-col items-center justify-center min-h-[400px] border-2 border-dashed border-border rounded-[24px]">
 <div className="text-sm font-bold text-muted-foreground">Dashboard is Empty</div>
 <div className="text-xs text-muted-foreground mt-2">Open the Widget Studio to add widgets.</div>
 </div>
 );
 }
 ...
 <div className="text-xs font-bold text-muted-foreground">{manifest.name}</div>
 <div className="text-[10px] text-muted-foreground mt-1">Component not mapped yet</div>
 </div>
 )}
 </WidgetWrapper>
 </div>
